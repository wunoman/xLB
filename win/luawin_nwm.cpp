...
int load_nwm(lua_State *L) {
  ...
  xlb_module(L, MODULE_NAME)({
    ...
    xlb_f(
        ...
        xlb_f("GetNetScheduleAccountInformation",
        ...
        xlb_f("NetAuditWrite", NetAuditWrite),
...
#if defined(WINVER) && (WINVER >= 0x0602)
        xlb_f("NetRequestProvisioningPackageInstall",
        ...
        xlb_f("NetUnjoinDomain", NetUnjoinDomain),
        xlb_f("NetUseAdd", NetUseAdd), xlb_f("NetUseDel", NetUseDel),
        xlb_f("NetUseEnum", NetUseEnum), xlb_f("NetUseGetInfo", NetUseGetInfo),
        ...
        xlb_f("SetNetScheduleAccountInformation",
              SetNetScheduleAccountInformation),

        xlb_class<ADMIN_OTHER_INFO>("ADMIN_OTHER_INFO")
            .constructor<>()
            .destructor()
            .property("alrtad_errcode", &ADMIN_OTHER_INFO::alrtad_errcode)
            .property("alrtad_numstrings",
                      &ADMIN_OTHER_INFO::alrtad_numstrings),
        xlb_class<AT_ENUM>("AT_ENUM")
            .constructor<>()
            .destructor()
        ...
        xlb_const("JOB_RUNS_TODAY", JOB_RUNS_TODAY),
        xlb_const("JOB_NONINTERACTIVE", JOB_NONINTERACTIVE),
        xlb_class<DSREG_JOIN_INFO>("DSREG_JOIN_INFO")
            .constructor<>()
            .destructor()
            ...
            .property("pszTenantDisplayName",
                      &DSREG_JOIN_INFO::pszTenantDisplayName)
            .property("pszMdmEnrollmentUrl",
                      &DSREG_JOIN_INFO::pszMdmEnrollmentUrl)
            .property("pszMdmTermsOfUseUrl",
                      &DSREG_JOIN_INFO::pszMdmTermsOfUseUrl)
            .property("pszMdmComplianceUrl",
                      &DSREG_JOIN_INFO::pszMdmComplianceUrl)
            .property("pszUserSettingSyncUrl",
                      &DSREG_JOIN_INFO::pszUserSettingSyncUrl)
            .property("pUserInfo", &DSREG_JOIN_INFO::pUserInfo),
        xlb_class<DSREG_USER_INFO>("DSREG_USER_INFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<GROUP_INFO_3>("GROUP_INFO_3")
            .constructor<>()
            .destructor()
        ...
        xlb_class<GROUP_USERS_INFO_0>("GROUP_USERS_INFO_0")
            .constructor<>()
            .destructor()
            .property("grui0_name", &GROUP_USERS_INFO_0::grui0_name),
        xlb_class<GROUP_USERS_INFO_1>("GROUP_USERS_INFO_1")
            .constructor<>()
            .destructor()
            .property("grui1_name", &GROUP_USERS_INFO_1::grui1_name)
            .property("grui1_attributes",
                      &GROUP_USERS_INFO_1::grui1_attributes),
        ...
        xlb_class<LOCALGROUP_INFO_0>("LOCALGROUP_INFO_0")
            .constructor<>()
            .destructor()
            .property("lgrpi0_name", &LOCALGROUP_INFO_0::lgrpi0_name),
        xlb_class<LOCALGROUP_INFO_1>("LOCALGROUP_INFO_1")
            .constructor<>()
            .destructor()
            .property("lgrpi1_name", &LOCALGROUP_INFO_1::lgrpi1_name)
            .property("lgrpi1_comment", &LOCALGROUP_INFO_1::lgrpi1_comment),
        xlb_class<LOCALGROUP_INFO_1002>("LOCALGROUP_INFO_1002")
            .constructor<>()
            .destructor()
            .property("lgrpi1002_comment",
                      &LOCALGROUP_INFO_1002::lgrpi1002_comment),
        xlb_class<LOCALGROUP_MEMBERS_INFO_0>("LOCALGROUP_MEMBERS_INFO_0")
            .constructor<>()
            .destructor()
            .property("lgrmi0_sid", &LOCALGROUP_MEMBERS_INFO_0::lgrmi0_sid),
        xlb_class<LOCALGROUP_MEMBERS_INFO_1>("LOCALGROUP_MEMBERS_INFO_1")
            .constructor<>()
            .destructor()
            .property("lgrmi1_sid", &LOCALGROUP_MEMBERS_INFO_1::lgrmi1_sid)
            .property("lgrmi1_sidusage",
                      &LOCALGROUP_MEMBERS_INFO_1::lgrmi1_sidusage)
            .property("lgrmi1_name", &LOCALGROUP_MEMBERS_INFO_1::lgrmi1_name),
        xlb_class<LOCALGROUP_MEMBERS_INFO_2>("LOCALGROUP_MEMBERS_INFO_2")
            .constructor<>()
            .destructor()
            .property("lgrmi2_sid", &LOCALGROUP_MEMBERS_INFO_2::lgrmi2_sid)
            .property("lgrmi2_sidusage",
                      &LOCALGROUP_MEMBERS_INFO_2::lgrmi2_sidusage)
            .property("lgrmi2_domainandname",
                      &LOCALGROUP_MEMBERS_INFO_2::lgrmi2_domainandname),
        ...
        xlb_class<LOCALGROUP_MEMBERS_INFO_3>("LOCALGROUP_MEMBERS_INFO_3")
            .constructor<>()
            .destructor()
            .property("lgrmi3_domainandname",
                      &LOCALGROUP_MEMBERS_INFO_3::lgrmi3_domainandname),
        xlb_class<LOCALGROUP_USERS_INFO_0>("LOCALGROUP_USERS_INFO_0")
            .constructor<>()
            .destructor()
            .property("lgrui0_name", &LOCALGROUP_USERS_INFO_0::lgrui0_name),
        xlb_class<MSG_INFO_0>("MSG_INFO_0")
            .constructor<>()
            .destructor()
            .property("msgi0_name", &MSG_INFO_0::msgi0_name),
        xlb_class<MSG_INFO_1>("MSG_INFO_1")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NET_DISPLAY_GROUP>("NET_DISPLAY_GROUP")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NET_DISPLAY_MACHINE>("NET_DISPLAY_MACHINE")
            .constructor<>()
            .destructor()
            ...
            .property("usri2_next_index",
                      &NET_DISPLAY_MACHINE::usri2_next_index),
        ...
        xlb_const("UF_ENCRYPTED_TEXT_PASSWORD_ALLOWED",
        ...
        xlb_const("UF_TRUSTED_TO_AUTHENTICATE_FOR_DELEGATION",
        ...
        xlb_class<NET_DISPLAY_USER>("NET_DISPLAY_USER")
            .constructor<>()
            .destructor()
        ...
        xlb_const("UF_SERVER_TRUST_ACCOUNT", UF_SERVER_TRUST_ACCOUNT),
        xlb_const("UF_INTERDOMAIN_TRUST_ACCOUNT", UF_INTERDOMAIN_TRUST_ACCOUNT),
        xlb_class<NET_VALIDATE_AUTHENTICATION_INPUT_ARG>(
            "NET_VALIDATE_AUTHENTICATION_INPUT_ARG")
            .constructor<>()
            .destructor()
            .property(
                "InputPersistedFields",
                &NET_VALIDATE_AUTHENTICATION_INPUT_ARG::InputPersistedFields)
            .property("PasswordMatched",
                      &NET_VALIDATE_AUTHENTICATION_INPUT_ARG::PasswordMatched),
        xlb_class<NET_VALIDATE_OUTPUT_ARG>("NET_VALIDATE_OUTPUT_ARG")
            .constructor<>()
            .destructor()
            .property("ChangedPersistedFields",
                      &NET_VALIDATE_OUTPUT_ARG::ChangedPersistedFields)
            .property("ValidationStatus",
                      &NET_VALIDATE_OUTPUT_ARG::ValidationStatus),
        ...
        xlb_const("NERR_PasswordNotComplexEnough",
        ...
        xlb_const("NERR_PasswordFilterError", NERR_PasswordFilterError),
        xlb_const("NERR_Success", NERR_Success),
        xlb_class<NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG>(
            "NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG")
            .constructor<>()
            .destructor()
            .property(
                "InputPersistedFields",
                &NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG::InputPersistedFields)
            .property("ClearPassword",
                      &NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG::ClearPassword)
            .property("UserAccountName",
                      &NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG::UserAccountName)
            .property("HashedPassword",
                      &NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG::HashedPassword)
            .property("PasswordMatch",
                      &NET_VALIDATE_PASSWORD_CHANGE_INPUT_ARG::PasswordMatch),
        xlb_class<NET_VALIDATE_PASSWORD_HASH>("NET_VALIDATE_PASSWORD_HASH")
            .constructor<>()
            .destructor()
            .property("Length", &NET_VALIDATE_PASSWORD_HASH::Length)
            .property("Hash", &NET_VALIDATE_PASSWORD_HASH::Hash),
        xlb_class<NET_VALIDATE_PASSWORD_RESET_INPUT_ARG>(
            "NET_VALIDATE_PASSWORD_RESET_INPUT_ARG")
            .constructor<>()
            .destructor()
            .property(
                "InputPersistedFields",
                &NET_VALIDATE_PASSWORD_RESET_INPUT_ARG::InputPersistedFields)
            .property("ClearPassword",
                      &NET_VALIDATE_PASSWORD_RESET_INPUT_ARG::ClearPassword)
            .property("UserAccountName",
                      &NET_VALIDATE_PASSWORD_RESET_INPUT_ARG::UserAccountName)
            .property("HashedPassword",
                      &NET_VALIDATE_PASSWORD_RESET_INPUT_ARG::HashedPassword)
            .property("PasswordMustChangeAtNextLogon",
                      &NET_VALIDATE_PASSWORD_RESET_INPUT_ARG::
                          PasswordMustChangeAtNextLogon)
            .property("ClearLockout",
                      &NET_VALIDATE_PASSWORD_RESET_INPUT_ARG::ClearLockout),
        xlb_class<NET_VALIDATE_PERSISTED_FIELDS>(
            "NET_VALIDATE_PERSISTED_FIELDS")
            .constructor<>()
            .destructor()
            .property("PresentFields",
                      &NET_VALIDATE_PERSISTED_FIELDS::PresentFields)
            .property("PasswordLastSet",
                      &NET_VALIDATE_PERSISTED_FIELDS::PasswordLastSet)
            .property("BadPasswordTime",
                      &NET_VALIDATE_PERSISTED_FIELDS::BadPasswordTime)
            .property("LockoutTime",
                      &NET_VALIDATE_PERSISTED_FIELDS::LockoutTime)
            .property("BadPasswordCount",
                      &NET_VALIDATE_PERSISTED_FIELDS::BadPasswordCount)
            .property("PasswordHistoryLength",
                      &NET_VALIDATE_PERSISTED_FIELDS::PasswordHistoryLength)
            .property("PasswordHistory",
                      &NET_VALIDATE_PERSISTED_FIELDS::PasswordHistory),
        xlb_const("NET_VALIDATE_PASSWORD_LAST_SET",
                  NET_VALIDATE_PASSWORD_LAST_SET),
        xlb_const("NET_VALIDATE_BAD_PASSWORD_TIME",
                  NET_VALIDATE_BAD_PASSWORD_TIME),
        xlb_const("NET_VALIDATE_LOCKOUT_TIME", NET_VALIDATE_LOCKOUT_TIME),
        xlb_const("NET_VALIDATE_BAD_PASSWORD_COUNT",
                  NET_VALIDATE_BAD_PASSWORD_COUNT),
        xlb_const("NET_VALIDATE_PASSWORD_HISTORY_LENGTH",
                  NET_VALIDATE_PASSWORD_HISTORY_LENGTH),
        xlb_const("NET_VALIDATE_PASSWORD_HISTORY",
                  NET_VALIDATE_PASSWORD_HISTORY),
        xlb_class<NETSETUP_PROVISIONING_PARAMS>("NETSETUP_PROVISIONING_PARAMS")
            .constructor<>()
            .destructor()
            ...
            .property("lpMachineAccountOU",
                      &NETSETUP_PROVISIONING_PARAMS::lpMachineAccountOU)
            .property("lpDcName", &NETSETUP_PROVISIONING_PARAMS::lpDcName)
            .property("dwProvisionOptions",
                      &NETSETUP_PROVISIONING_PARAMS::dwProvisionOptions)
            .property("aCertTemplateNames",
                      &NETSETUP_PROVISIONING_PARAMS::aCertTemplateNames)
            .property("cCertTemplateNames",
                      &NETSETUP_PROVISIONING_PARAMS::cCertTemplateNames)
            .property("aMachinePolicyNames",
                      &NETSETUP_PROVISIONING_PARAMS::aMachinePolicyNames)
            .property("cMachinePolicyNames",
                      &NETSETUP_PROVISIONING_PARAMS::cMachinePolicyNames)
            .property("aMachinePolicyPaths",
                      &NETSETUP_PROVISIONING_PARAMS::aMachinePolicyPaths)
            .property("cMachinePolicyPaths",
                      &NETSETUP_PROVISIONING_PARAMS::cMachinePolicyPaths)
            .property("lpNetbiosName",
                      &NETSETUP_PROVISIONING_PARAMS::lpNetbiosName)
            .property("lpSiteName", &NETSETUP_PROVISIONING_PARAMS::lpSiteName)
            .property("lpPrimaryDNSDomain",
                      &NETSETUP_PROVISIONING_PARAMS::lpPrimaryDNSDomain),
        xlb_const("NETSETUP_PROVISIONING_PARAMS_CURRENT_VERSION",
                  NETSETUP_PROVISIONING_PARAMS_CURRENT_VERSION),
        xlb_const("NETSETUP_PROVISION_DOWNLEVEL_PRIV_SUPPORT",
                  NETSETUP_PROVISION_DOWNLEVEL_PRIV_SUPPORT),
        xlb_const("NETSETUP_PROVISION_REUSE_ACCOUNT",
                  NETSETUP_PROVISION_REUSE_ACCOUNT),
        xlb_const("NETSETUP_PROVISION_USE_DEFAULT_PASSWORD",
                  NETSETUP_PROVISION_USE_DEFAULT_PASSWORD),
        xlb_const("NETSETUP_PROVISION_SKIP_ACCOUNT_SEARCH",
                  NETSETUP_PROVISION_SKIP_ACCOUNT_SEARCH),
        xlb_const("NETSETUP_PROVISION_ROOT_CA_CERTS",
                  NETSETUP_PROVISION_ROOT_CA_CERTS),
        xlb_class<PRINT_OTHER_INFO>("PRINT_OTHER_INFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SERVER_INFO_100>("SERVER_INFO_100")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SERVER_INFO_1005>("SERVER_INFO_1005")
            .constructor<>()
            .destructor()
            .property("sv1005_comment", &SERVER_INFO_1005::sv1005_comment),
        xlb_class<SERVER_INFO_101>("SERVER_INFO_101")
            .constructor<>()
            .destructor()
            .property("sv101_platform_id", &SERVER_INFO_101::sv101_platform_id)
            .property("sv101_name", &SERVER_INFO_101::sv101_name)
            .property("sv101_version_major",
                      &SERVER_INFO_101::sv101_version_major)
            .property("sv101_version_minor",
                      &SERVER_INFO_101::sv101_version_minor)
        ...
        xlb_class<SERVER_INFO_1010>("SERVER_INFO_1010")
            .constructor<>()
            .destructor()
            .property("sv1010_disc", &SERVER_INFO_1010::sv1010_disc),
        xlb_class<SERVER_INFO_1016>("SERVER_INFO_1016")
            .constructor<>()
            .destructor()
            .property("sv1016_hidden", &SERVER_INFO_1016::sv1016_hidden),
        xlb_const("SV_VISIBLE", SV_VISIBLE), xlb_const("SV_HIDDEN", SV_HIDDEN),
        xlb_class<SERVER_INFO_1017>("SERVER_INFO_1017")
            .constructor<>()
            .destructor()
            .property("sv1017_announce", &SERVER_INFO_1017::sv1017_announce),
        xlb_class<SERVER_INFO_1018>("SERVER_INFO_1018")
            .constructor<>()
            .destructor()
            .property("sv1018_anndelta", &SERVER_INFO_1018::sv1018_anndelta),
        xlb_class<SERVER_INFO_102>("SERVER_INFO_102")
            .constructor<>()
            .destructor()
            .property("sv102_platform_id", &SERVER_INFO_102::sv102_platform_id)
            .property("sv102_name", &SERVER_INFO_102::sv102_name)
            .property("sv102_version_major",
                      &SERVER_INFO_102::sv102_version_major)
            .property("sv102_version_minor",
                      &SERVER_INFO_102::sv102_version_minor)
        ...
        xlb_const("SV_TYPE_LOCAL_LIST_ONLY", SV_TYPE_LOCAL_LIST_ONLY),
        xlb_const("SV_TYPE_DOMAIN_ENUM", SV_TYPE_DOMAIN_ENUM),
        xlb_class<SERVER_INFO_1107>("SERVER_INFO_1107")
            .constructor<>()
            .destructor()
            .property("sv1107_users", &SERVER_INFO_1107::sv1107_users),
        xlb_class<SERVER_INFO_1501>("SERVER_INFO_1501")
            .constructor<>()
            .destructor()
            .property("sv1501_sessopens", &SERVER_INFO_1501::sv1501_sessopens),
        xlb_class<SERVER_INFO_1502>("SERVER_INFO_1502")
            .constructor<>()
            .destructor()
            .property("sv1502_sessvcs", &SERVER_INFO_1502::sv1502_sessvcs),
        xlb_class<SERVER_INFO_1503>("SERVER_INFO_1503")
            .constructor<>()
            .destructor()
            .property("sv1503_opensearch",
                      &SERVER_INFO_1503::sv1503_opensearch),
        xlb_class<SERVER_INFO_1506>("SERVER_INFO_1506")
            .constructor<>()
            .destructor()
            .property("sv1506_maxworkitems",
                      &SERVER_INFO_1506::sv1506_maxworkitems),
        xlb_class<SERVER_INFO_1509>("SERVER_INFO_1509")
            .constructor<>()
            .destructor()
            .property("sv1509_maxrawbuflen",
                      &SERVER_INFO_1509::sv1509_maxrawbuflen),
        xlb_class<SERVER_INFO_1510>("SERVER_INFO_1510")
            .constructor<>()
            .destructor()
            .property("sv1510_sessusers", &SERVER_INFO_1510::sv1510_sessusers),
        xlb_class<SERVER_INFO_1511>("SERVER_INFO_1511")
            .constructor<>()
            .destructor()
            .property("sv1511_sessconns", &SERVER_INFO_1511::sv1511_sessconns),
        xlb_class<SERVER_INFO_1512>("SERVER_INFO_1512")
            .constructor<>()
            .destructor()
            .property("sv1512_maxnonpagedmemoryusage",
                      &SERVER_INFO_1512::sv1512_maxnonpagedmemoryusage),
        xlb_class<SERVER_INFO_1513>("SERVER_INFO_1513")
            .constructor<>()
            .destructor()
            .property("sv1513_maxpagedmemoryusage",
                      &SERVER_INFO_1513::sv1513_maxpagedmemoryusage),
        xlb_class<SERVER_INFO_1515>("SERVER_INFO_1515")
            .constructor<>()
            .destructor()
            .property("sv1515_enableforcedlogoff",
                      &SERVER_INFO_1515::sv1515_enableforcedlogoff),
        xlb_class<SERVER_INFO_1516>("SERVER_INFO_1516")
            .constructor<>()
            .destructor()
            .property("sv1516_timesource",
                      &SERVER_INFO_1516::sv1516_timesource),
        xlb_class<SERVER_INFO_1518>("SERVER_INFO_1518")
            .constructor<>()
            .destructor()
            .property("sv1518_lmannounce",
                      &SERVER_INFO_1518::sv1518_lmannounce),
        xlb_class<SERVER_INFO_1523>("SERVER_INFO_1523")
            .constructor<>()
            .destructor()
            .property("sv1523_maxkeepsearch",
                      &SERVER_INFO_1523::sv1523_maxkeepsearch),
        xlb_class<SERVER_INFO_1528>("SERVER_INFO_1528")
            .constructor<>()
            .destructor()
            .property("sv1528_scavtimeout",
                      &SERVER_INFO_1528::sv1528_scavtimeout),
        xlb_class<SERVER_INFO_1529>("SERVER_INFO_1529")
            .constructor<>()
            .destructor()
            .property("sv1529_minrcvqueue",
                      &SERVER_INFO_1529::sv1529_minrcvqueue),
        xlb_class<SERVER_INFO_1530>("SERVER_INFO_1530")
            .constructor<>()
            .destructor()
            .property("sv1530_minfreeworkitems",
                      &SERVER_INFO_1530::sv1530_minfreeworkitems),
        xlb_class<SERVER_INFO_1533>("SERVER_INFO_1533")
            .constructor<>()
            .destructor()
            .property("sv1533_maxmpxct", &SERVER_INFO_1533::sv1533_maxmpxct),
        xlb_class<SERVER_INFO_1536>("SERVER_INFO_1536")
            .constructor<>()
            .destructor()
            .property("sv1536_enableoplocks",
                      &SERVER_INFO_1536::sv1536_enableoplocks),
        xlb_class<SERVER_INFO_1538>("SERVER_INFO_1538")
            .constructor<>()
            .destructor()
            .property("sv1538_enablefcbopens",
                      &SERVER_INFO_1538::sv1538_enablefcbopens),
        xlb_class<SERVER_INFO_1539>("SERVER_INFO_1539")
            .constructor<>()
            .destructor()
            .property("sv1539_enableraw", &SERVER_INFO_1539::sv1539_enableraw),
        xlb_class<SERVER_INFO_1540>("SERVER_INFO_1540")
            .constructor<>()
            .destructor()
            .property("sv1540_enablesharednetdrives",
                      &SERVER_INFO_1540::sv1540_enablesharednetdrives),
        xlb_class<SERVER_INFO_1541>("SERVER_INFO_1541")
            .constructor<>()
            .destructor()
            .property("sv1541_minfreeconnections",
                      &SERVER_INFO_1541::sv1541_minfreeconnections),
        xlb_class<SERVER_INFO_1542>("SERVER_INFO_1542")
            .constructor<>()
            .destructor()
            .property("sv1542_maxfreeconnections",
                      &SERVER_INFO_1542::sv1542_maxfreeconnections),
        xlb_class<SERVER_INFO_1544>("SERVER_INFO_1544")
            .constructor<>()
            .destructor()
            .property("sv1544_initconntable",
                      &SERVER_INFO_1544::sv1544_initconntable),
        xlb_class<SERVER_INFO_1550>("SERVER_INFO_1550")
            .constructor<>()
            .destructor()
            .property("sv1550_diskspacethreshold",
                      &SERVER_INFO_1550::sv1550_diskspacethreshold),
        xlb_class<SERVER_INFO_1552>("SERVER_INFO_1552")
            .constructor<>()
            .destructor()
            .property("sv1552_maxlinkdelay",
                      &SERVER_INFO_1552::sv1552_maxlinkdelay),
        xlb_class<SERVER_INFO_402>("SERVER_INFO_402")
            .constructor<>()
            .destructor()
            ...
            .property("sv402_numfiletasks",
                      &SERVER_INFO_402::sv402_numfiletasks)
            ...
            .property("sv402_srvheuristics",
                      &SERVER_INFO_402::sv402_srvheuristics),
        xlb_class<SERVER_INFO_403>("SERVER_INFO_403")
            .constructor<>()
            .destructor()
            ...
            .property("sv403_numfiletasks",
                      &SERVER_INFO_403::sv403_numfiletasks)
            ...
            .property("sv403_srvheuristics",
                      &SERVER_INFO_403::sv403_srvheuristics)
            .property("sv403_auditedevents",
                      &SERVER_INFO_403::sv403_auditedevents)
        ...
        xlb_class<SERVER_INFO_502>("SERVER_INFO_502")
            .constructor<>()
            .destructor()
            ...
            .property("sv502_initworkitems",
                      &SERVER_INFO_502::sv502_initworkitems)
            .property("sv502_maxworkitems",
                      &SERVER_INFO_502::sv502_maxworkitems)
            .property("sv502_rawworkitems",
                      &SERVER_INFO_502::sv502_rawworkitems)
            .property("sv502_irpstacksize",
                      &SERVER_INFO_502::sv502_irpstacksize)
            .property("sv502_maxrawbuflen",
                      &SERVER_INFO_502::sv502_maxrawbuflen)
            .property("sv502_sessusers", &SERVER_INFO_502::sv502_sessusers)
            .property("sv502_sessconns", &SERVER_INFO_502::sv502_sessconns)
            .property("sv502_maxpagedmemoryusage",
                      &SERVER_INFO_502::sv502_maxpagedmemoryusage)
            .property("sv502_maxnonpagedmemoryusage",
                      &SERVER_INFO_502::sv502_maxnonpagedmemoryusage)
            .property("sv502_enablesoftcompat",
                      &SERVER_INFO_502::sv502_enablesoftcompat)
            .property("sv502_enableforcedlogoff",
                      &SERVER_INFO_502::sv502_enableforcedlogoff)
            .property("sv502_timesource", &SERVER_INFO_502::sv502_timesource)
            .property("sv502_acceptdownlevelapis",
                      &SERVER_INFO_502::sv502_acceptdownlevelapis)
            .property("sv502_lmannounce", &SERVER_INFO_502::sv502_lmannounce),
        xlb_class<SERVER_INFO_503>("SERVER_INFO_503")
            .constructor<>()
            .destructor()
            ...
            .property("sv503_initworkitems",
                      &SERVER_INFO_503::sv503_initworkitems)
            .property("sv503_maxworkitems",
                      &SERVER_INFO_503::sv503_maxworkitems)
            .property("sv503_rawworkitems",
                      &SERVER_INFO_503::sv503_rawworkitems)
            .property("sv503_irpstacksize",
                      &SERVER_INFO_503::sv503_irpstacksize)
            .property("sv503_maxrawbuflen",
                      &SERVER_INFO_503::sv503_maxrawbuflen)
            .property("sv503_sessusers", &SERVER_INFO_503::sv503_sessusers)
            .property("sv503_sessconns", &SERVER_INFO_503::sv503_sessconns)
            .property("sv503_maxpagedmemoryusage",
                      &SERVER_INFO_503::sv503_maxpagedmemoryusage)
            .property("sv503_maxnonpagedmemoryusage",
                      &SERVER_INFO_503::sv503_maxnonpagedmemoryusage)
            .property("sv503_enablesoftcompat",
                      &SERVER_INFO_503::sv503_enablesoftcompat)
            .property("sv503_enableforcedlogoff",
                      &SERVER_INFO_503::sv503_enableforcedlogoff)
            .property("sv503_timesource", &SERVER_INFO_503::sv503_timesource)
            .property("sv503_acceptdownlevelapis",
                      &SERVER_INFO_503::sv503_acceptdownlevelapis)
            .property("sv503_lmannounce", &SERVER_INFO_503::sv503_lmannounce)
            .property("sv503_domain", &SERVER_INFO_503::sv503_domain)
            .property("sv503_maxcopyreadlen",
                      &SERVER_INFO_503::sv503_maxcopyreadlen)
            .property("sv503_maxcopywritelen",
                      &SERVER_INFO_503::sv503_maxcopywritelen)
            .property("sv503_minkeepsearch",
                      &SERVER_INFO_503::sv503_minkeepsearch)
            .property("sv503_maxkeepsearch",
                      &SERVER_INFO_503::sv503_maxkeepsearch)
            .property("sv503_minkeepcomplsearch",
                      &SERVER_INFO_503::sv503_minkeepcomplsearch)
            .property("sv503_maxkeepcomplsearch",
                      &SERVER_INFO_503::sv503_maxkeepcomplsearch)
            .property("sv503_threadcountadd",
                      &SERVER_INFO_503::sv503_threadcountadd)
            .property("sv503_numblockthreads",
                      &SERVER_INFO_503::sv503_numblockthreads)
            .property("sv503_scavtimeout", &SERVER_INFO_503::sv503_scavtimeout)
            .property("sv503_minrcvqueue", &SERVER_INFO_503::sv503_minrcvqueue)
            .property("sv503_minfreeworkitems",
                      &SERVER_INFO_503::sv503_minfreeworkitems)
            .property("sv503_xactmemsize", &SERVER_INFO_503::sv503_xactmemsize)
            .property("sv503_threadpriority",
                      &SERVER_INFO_503::sv503_threadpriority)
            .property("sv503_maxmpxct", &SERVER_INFO_503::sv503_maxmpxct)
            .property("sv503_oplockbreakwait",
                      &SERVER_INFO_503::sv503_oplockbreakwait)
            .property("sv503_oplockbreakresponsewait",
                      &SERVER_INFO_503::sv503_oplockbreakresponsewait)
            .property("sv503_enableoplocks",
                      &SERVER_INFO_503::sv503_enableoplocks)
            .property("sv503_enableoplockforceclose",
                      &SERVER_INFO_503::sv503_enableoplockforceclose)
            .property("sv503_enablefcbopens",
                      &SERVER_INFO_503::sv503_enablefcbopens)
            .property("sv503_enableraw", &SERVER_INFO_503::sv503_enableraw)
            .property("sv503_enablesharednetdrives",
                      &SERVER_INFO_503::sv503_enablesharednetdrives)
            .property("sv503_minfreeconnections",
                      &SERVER_INFO_503::sv503_minfreeconnections)
            .property("sv503_maxfreeconnections",
                      &SERVER_INFO_503::sv503_maxfreeconnections),
        xlb_class<SERVER_TRANSPORT_INFO_0>("SERVER_TRANSPORT_INFO_0")
            .constructor<>()
            .destructor()
            .property("svti0_numberofvcs",
                      &SERVER_TRANSPORT_INFO_0::svti0_numberofvcs)
            .property("svti0_transportname",
                      &SERVER_TRANSPORT_INFO_0::svti0_transportname)
            .property("svti0_transportaddress",
                      &SERVER_TRANSPORT_INFO_0::svti0_transportaddress)
            .property("svti0_transportaddresslength",
                      &SERVER_TRANSPORT_INFO_0::svti0_transportaddresslength)
            .property("svti0_networkaddress",
                      &SERVER_TRANSPORT_INFO_0::svti0_networkaddress),
        xlb_class<SERVER_TRANSPORT_INFO_1>("SERVER_TRANSPORT_INFO_1")
            .constructor<>()
            .destructor()
            .property("svti1_numberofvcs",
                      &SERVER_TRANSPORT_INFO_1::svti1_numberofvcs)
            .property("svti1_transportname",
                      &SERVER_TRANSPORT_INFO_1::svti1_transportname)
            .property("svti1_transportaddress",
                      &SERVER_TRANSPORT_INFO_1::svti1_transportaddress)
            .property("svti1_transportaddresslength",
                      &SERVER_TRANSPORT_INFO_1::svti1_transportaddresslength)
            .property("svti1_networkaddress",
                      &SERVER_TRANSPORT_INFO_1::svti1_networkaddress)
            .property("svti1_domain", &SERVER_TRANSPORT_INFO_1::svti1_domain),
        xlb_class<SERVER_TRANSPORT_INFO_2>("SERVER_TRANSPORT_INFO_2")
            .constructor<>()
            .destructor()
            .property("svti2_numberofvcs",
                      &SERVER_TRANSPORT_INFO_2::svti2_numberofvcs)
            .property("svti2_transportname",
                      &SERVER_TRANSPORT_INFO_2::svti2_transportname)
            .property("svti2_transportaddress",
                      &SERVER_TRANSPORT_INFO_2::svti2_transportaddress)
            .property("svti2_transportaddresslength",
                      &SERVER_TRANSPORT_INFO_2::svti2_transportaddresslength)
            .property("svti2_networkaddress",
                      &SERVER_TRANSPORT_INFO_2::svti2_networkaddress)
        ...
        xlb_class<SERVER_TRANSPORT_INFO_3>("SERVER_TRANSPORT_INFO_3")
            .constructor<>()
            .destructor()
            .property("svti3_numberofvcs",
                      &SERVER_TRANSPORT_INFO_3::svti3_numberofvcs)
            .property("svti3_transportname",
                      &SERVER_TRANSPORT_INFO_3::svti3_transportname)
            .property("svti3_transportaddress",
                      &SERVER_TRANSPORT_INFO_3::svti3_transportaddress)
            .property("svti3_transportaddresslength",
                      &SERVER_TRANSPORT_INFO_3::svti3_transportaddresslength)
            .property("svti3_networkaddress",
                      &SERVER_TRANSPORT_INFO_3::svti3_networkaddress)
            .property("svti3_domain", &SERVER_TRANSPORT_INFO_3::svti3_domain)
            .property("svti3_flags", &SERVER_TRANSPORT_INFO_3::svti3_flags)
            .property("svti3_passwordlength",
                      &SERVER_TRANSPORT_INFO_3::svti3_passwordlength)
            .property("svti3_password",
                      &SERVER_TRANSPORT_INFO_3::svti3_password),
        xlb_class<STD_ALERT>("STD_ALERT")
            .constructor<>()
            .destructor()
        ...
        xlb_class<TIME_OF_DAY_INFO>("TIME_OF_DAY_INFO")
            .constructor<>()
            .destructor()
        ...
        xlb_const("USE_OK", USE_OK), xlb_const("USE_PAUSED", USE_PAUSED),
        xlb_const("USE_SESSLOST", USE_SESSLOST),
        xlb_const("USE_DISCONN", USE_DISCONN),
        xlb_const("USE_NETERR", USE_NETERR), xlb_const("USE_CONN", USE_CONN),
        xlb_const("USE_RECONN", USE_RECONN),
        xlb_const("USE_WILDCARD", USE_WILDCARD),
        xlb_const("USE_DISKDEV", USE_DISKDEV),
        xlb_const("USE_SPOOLDEV", USE_SPOOLDEV), xlb_const("USE_IPC", USE_IPC),
        xlb_class<USE_INFO_2>("USE_INFO_2")
            .constructor<>()
            .destructor()
        ...
        xlb_const("UF_SERVER_TRUST_ACCOUNT", UF_SERVER_TRUST_ACCOUNT),
        xlb_const("UF_INTERDOMAIN_TRUST_ACCOUNT", UF_INTERDOMAIN_TRUST_ACCOUNT),
        xlb_class<USER_INFO_10>("USER_INFO_10")
            .constructor<>()
            .destructor()
        ...
        xlb_class<USER_INFO_1003>("USER_INFO_1003")
            .constructor<>()
            .destructor()
            .property("usri1003_password", &USER_INFO_1003::usri1003_password),
        xlb_class<USER_INFO_1005>("USER_INFO_1005")
            .constructor<>()
            .destructor()
        ...
        xlb_const("USER_PRIV_USER", USER_PRIV_USER),
        xlb_const("USER_PRIV_ADMIN", USER_PRIV_ADMIN),
        xlb_class<USER_INFO_1006>("USER_INFO_1006")
            .constructor<>()
            .destructor()
            .property("usri1006_home_dir", &USER_INFO_1006::usri1006_home_dir),
        xlb_class<USER_INFO_1007>("USER_INFO_1007")
            .constructor<>()
            .destructor()
            .property("usri1007_comment", &USER_INFO_1007::usri1007_comment),
        xlb_class<USER_INFO_1008>("USER_INFO_1008")
            .constructor<>()
            .destructor()
        ...
        xlb_const("UF_SERVER_TRUST_ACCOUNT", UF_SERVER_TRUST_ACCOUNT),
        xlb_const("UF_INTERDOMAIN_TRUST_ACCOUNT", UF_INTERDOMAIN_TRUST_ACCOUNT),
        xlb_class<USER_INFO_1009>("USER_INFO_1009")
            .constructor<>()
            .destructor()
            .property("usri1009_script_path",
                      &USER_INFO_1009::usri1009_script_path),
        xlb_class<USER_INFO_1010>("USER_INFO_1010")
            .constructor<>()
            .destructor()
            .property("usri1010_auth_flags",
                      &USER_INFO_1010::usri1010_auth_flags),
        ...
        xlb_class<USER_INFO_1011>("USER_INFO_1011")
            .constructor<>()
            .destructor()
            .property("usri1011_full_name",
                      &USER_INFO_1011::usri1011_full_name),
        xlb_class<USER_INFO_1012>("USER_INFO_1012")
            .constructor<>()
            .destructor()
            .property("usri1012_usr_comment",
                      &USER_INFO_1012::usri1012_usr_comment),
        xlb_class<USER_INFO_1013>("USER_INFO_1013")
            .constructor<>()
            .destructor()
            .property("usri1013_parms", &USER_INFO_1013::usri1013_parms),
        xlb_class<USER_INFO_1014>("USER_INFO_1014")
            .constructor<>()
            .destructor()
            .property("usri1014_workstations",
                      &USER_INFO_1014::usri1014_workstations),
        xlb_class<USER_INFO_1017>("USER_INFO_1017")
            .constructor<>()
            .destructor()
            .property("usri1017_acct_expires",
                      &USER_INFO_1017::usri1017_acct_expires),
        xlb_class<USER_INFO_1018>("USER_INFO_1018")
            .constructor<>()
            .destructor()
            .property("usri1018_max_storage",
                      &USER_INFO_1018::usri1018_max_storage),
        xlb_class<USER_INFO_1020>("USER_INFO_1020")
            .constructor<>()
            .destructor()
            .property("usri1020_units_per_week",
                      &USER_INFO_1020::usri1020_units_per_week)
            .property("usri1020_logon_hours",
                      &USER_INFO_1020::usri1020_logon_hours),
        xlb_class<USER_INFO_1023>("USER_INFO_1023")
            .constructor<>()
            .destructor()
            .property("usri1023_logon_server",
                      &USER_INFO_1023::usri1023_logon_server),
        xlb_class<USER_INFO_1024>("USER_INFO_1024")
            .constructor<>()
            .destructor()
            .property("usri1024_country_code",
                      &USER_INFO_1024::usri1024_country_code),
        xlb_class<USER_INFO_1025>("USER_INFO_1025")
            .constructor<>()
            .destructor()
            .property("usri1025_code_page",
                      &USER_INFO_1025::usri1025_code_page),
        xlb_class<USER_INFO_1051>("USER_INFO_1051")
            .constructor<>()
            .destructor()
            .property("usri1051_primary_group_id",
                      &USER_INFO_1051::usri1051_primary_group_id),
        xlb_class<USER_INFO_1052>("USER_INFO_1052")
            .constructor<>()
            .destructor()
            .property("usri1052_profile", &USER_INFO_1052::usri1052_profile),
        xlb_class<USER_INFO_1053>("USER_INFO_1053")
            .constructor<>()
            .destructor()
            .property("usri1053_home_dir_drive",
                      &USER_INFO_1053::usri1053_home_dir_drive),
        xlb_class<USER_INFO_11>("USER_INFO_11")
            .constructor<>()
            .destructor()
            ...
            .property("usri11_units_per_week",
                      &USER_INFO_11::usri11_units_per_week)
        ...
        xlb_const("AF_OP_SERVER", AF_OP_SERVER),
        xlb_const("AF_OP_ACCOUNTS", AF_OP_ACCOUNTS),
        xlb_class<USER_INFO_2>("USER_INFO_2")
            .constructor<>()
            .destructor()
            ...
            .property("usri2_units_per_week",
                      &USER_INFO_2::usri2_units_per_week)
        ...
        xlb_const("AF_OP_SERVER", AF_OP_SERVER),
        xlb_const("AF_OP_ACCOUNTS", AF_OP_ACCOUNTS),
        xlb_class<USER_INFO_20>("USER_INFO_20")
            .constructor<>()
            .destructor()
        ...
        xlb_class<USER_INFO_21>("USER_INFO_21")
            .constructor<>()
            .destructor()
            .property("usri21_password", &USER_INFO_21::usri21_password),
        xlb_class<USER_INFO_22>("USER_INFO_22")
            .constructor<>()
            .destructor()
            ...
            .property("usri22_units_per_week",
                      &USER_INFO_22::usri22_units_per_week)
        ...
        xlb_class<USER_INFO_23>("USER_INFO_23")
            .constructor<>()
            .destructor()
        ...
        xlb_class<USER_INFO_24>("USER_INFO_24")
            .constructor<>()
            .destructor()
            .property("usri24_internet_identity",
                      &USER_INFO_24::usri24_internet_identity)
            .property("usri24_flags", &USER_INFO_24::usri24_flags)
            .property("usri24_internet_provider_name",
                      &USER_INFO_24::usri24_internet_provider_name)
            .property("usri24_internet_principal_name",
                      &USER_INFO_24::usri24_internet_principal_name)
            .property("usri24_user_sid", &USER_INFO_24::usri24_user_sid),
        xlb_class<USER_INFO_3>("USER_INFO_3")
            .constructor<>()
            .destructor()
            ...
            .property("usri3_units_per_week",
                      &USER_INFO_3::usri3_units_per_week)
            ...
            .property("usri3_primary_group_id",
                      &USER_INFO_3::usri3_primary_group_id)
            .property("usri3_profile", &USER_INFO_3::usri3_profile)
            .property("usri3_home_dir_drive",
                      &USER_INFO_3::usri3_home_dir_drive)
            .property("usri3_password_expired",
                      &USER_INFO_3::usri3_password_expired),
        xlb_class<USER_INFO_4>("USER_INFO_4")
            .constructor<>()
            .destructor()
            ...
            .property("usri4_units_per_week",
                      &USER_INFO_4::usri4_units_per_week)
            ...
            .property("usri4_primary_group_id",
                      &USER_INFO_4::usri4_primary_group_id)
            .property("usri4_profile", &USER_INFO_4::usri4_profile)
            .property("usri4_home_dir_drive",
                      &USER_INFO_4::usri4_home_dir_drive)
            .property("usri4_password_expired",
                      &USER_INFO_4::usri4_password_expired),
        xlb_class<USER_MODALS_INFO_0>("USER_MODALS_INFO_0")
            .constructor<>()
            .destructor()
            .property("usrmod0_min_passwd_len",
                      &USER_MODALS_INFO_0::usrmod0_min_passwd_len)
            .property("usrmod0_max_passwd_age",
                      &USER_MODALS_INFO_0::usrmod0_max_passwd_age)
            .property("usrmod0_min_passwd_age",
                      &USER_MODALS_INFO_0::usrmod0_min_passwd_age)
            .property("usrmod0_force_logoff",
                      &USER_MODALS_INFO_0::usrmod0_force_logoff)
            .property("usrmod0_password_hist_len",
                      &USER_MODALS_INFO_0::usrmod0_password_hist_len),
        xlb_class<USER_MODALS_INFO_1>("USER_MODALS_INFO_1")
            .constructor<>()
            .destructor()
        ...
        xlb_class<USER_MODALS_INFO_1001>("USER_MODALS_INFO_1001")
            .constructor<>()
            .destructor()
            .property("usrmod1001_min_passwd_len",
                      &USER_MODALS_INFO_1001::usrmod1001_min_passwd_len),
        xlb_class<USER_MODALS_INFO_1002>("USER_MODALS_INFO_1002")
            .constructor<>()
            .destructor()
            .property("usrmod1002_max_passwd_age",
                      &USER_MODALS_INFO_1002::usrmod1002_max_passwd_age),
        xlb_class<USER_MODALS_INFO_1003>("USER_MODALS_INFO_1003")
            .constructor<>()
            .destructor()
            .property("usrmod1003_min_passwd_age",
                      &USER_MODALS_INFO_1003::usrmod1003_min_passwd_age),
        xlb_class<USER_MODALS_INFO_1004>("USER_MODALS_INFO_1004")
            .constructor<>()
            .destructor()
            .property("usrmod1004_force_logoff",
                      &USER_MODALS_INFO_1004::usrmod1004_force_logoff),
        xlb_class<USER_MODALS_INFO_1005>("USER_MODALS_INFO_1005")
            .constructor<>()
            .destructor()
            .property("usrmod1005_password_hist_len",
                      &USER_MODALS_INFO_1005::usrmod1005_password_hist_len),
        xlb_class<USER_MODALS_INFO_1006>("USER_MODALS_INFO_1006")
            .constructor<>()
            .destructor()
            .property("usrmod1006_role",
                      &USER_MODALS_INFO_1006::usrmod1006_role),
        xlb_const("UAS_ROLE_STANDALONE", UAS_ROLE_STANDALONE),
        xlb_const("UAS_ROLE_MEMBER", UAS_ROLE_MEMBER),
        xlb_const("UAS_ROLE_BACKUP", UAS_ROLE_BACKUP),
        xlb_const("UAS_ROLE_PRIMARY", UAS_ROLE_PRIMARY),
        xlb_class<USER_MODALS_INFO_1007>("USER_MODALS_INFO_1007")
            .constructor<>()
            .destructor()
            .property("usrmod1007_primary",
                      &USER_MODALS_INFO_1007::usrmod1007_primary),
        xlb_class<USER_MODALS_INFO_2>("USER_MODALS_INFO_2")
            .constructor<>()
            .destructor()
            .property("usrmod2_domain_name",
                      &USER_MODALS_INFO_2::usrmod2_domain_name)
            .property("usrmod2_domain_id",
                      &USER_MODALS_INFO_2::usrmod2_domain_id),
        xlb_class<USER_MODALS_INFO_3>("USER_MODALS_INFO_3")
            .constructor<>()
            .destructor()
            .property("usrmod3_lockout_duration",
                      &USER_MODALS_INFO_3::usrmod3_lockout_duration)
            .property("usrmod3_lockout_observation_window",
                      &USER_MODALS_INFO_3::usrmod3_lockout_observation_window)
            .property("usrmod3_lockout_threshold",
                      &USER_MODALS_INFO_3::usrmod3_lockout_threshold),
        xlb_class<USER_OTHER_INFO>("USER_OTHER_INFO")
            .constructor<>()
            .destructor()
            .property("alrtus_errcode", &USER_OTHER_INFO::alrtus_errcode)
            .property("alrtus_numstrings", &USER_OTHER_INFO::alrtus_numstrings),
        xlb_class<WKSTA_INFO_100>("WKSTA_INFO_100")
            .constructor<>()
            .destructor()
            .property("wki100_platform_id", &WKSTA_INFO_100::wki100_platform_id)
            .property("wki100_computername",
                      &WKSTA_INFO_100::wki100_computername)
        ...
        xlb_const("PLATFORM_ID_OSF", PLATFORM_ID_OSF),
        xlb_const("PLATFORM_ID_VMS", PLATFORM_ID_VMS),
        xlb_class<WKSTA_INFO_101>("WKSTA_INFO_101")
            .constructor<>()
            .destructor()
            .property("wki101_platform_id", &WKSTA_INFO_101::wki101_platform_id)
            .property("wki101_computername",
                      &WKSTA_INFO_101::wki101_computername)
        ...
        xlb_class<WKSTA_INFO_102>("WKSTA_INFO_102")
            .constructor<>()
            .destructor()
            .property("wki102_platform_id", &WKSTA_INFO_102::wki102_platform_id)
            .property("wki102_computername",
                      &WKSTA_INFO_102::wki102_computername)
            ...
            .property("wki102_logged_on_users",
                      &WKSTA_INFO_102::wki102_logged_on_users),
        xlb_class<WKSTA_INFO_502>("WKSTA_INFO_502")
            .constructor<>()
            .destructor()
            .property("wki502_char_wait", &WKSTA_INFO_502::wki502_char_wait)
            .property("wki502_collection_time",
                      &WKSTA_INFO_502::wki502_collection_time)
            .property("wki502_maximum_collection_count",
                      &WKSTA_INFO_502::wki502_maximum_collection_count)
            .property("wki502_keep_conn", &WKSTA_INFO_502::wki502_keep_conn)
            .property("wki502_max_cmds", &WKSTA_INFO_502::wki502_max_cmds)
            .property("wki502_sess_timeout",
                      &WKSTA_INFO_502::wki502_sess_timeout)
            .property("wki502_siz_char_buf",
                      &WKSTA_INFO_502::wki502_siz_char_buf)
            .property("wki502_max_threads", &WKSTA_INFO_502::wki502_max_threads)
            .property("wki502_lock_quota", &WKSTA_INFO_502::wki502_lock_quota)
            .property("wki502_lock_increment",
                      &WKSTA_INFO_502::wki502_lock_increment)
            .property("wki502_lock_maximum",
                      &WKSTA_INFO_502::wki502_lock_maximum)
            .property("wki502_pipe_increment",
                      &WKSTA_INFO_502::wki502_pipe_increment)
            .property("wki502_pipe_maximum",
                      &WKSTA_INFO_502::wki502_pipe_maximum)
            .property("wki502_cache_file_timeout",
                      &WKSTA_INFO_502::wki502_cache_file_timeout)
            .property("wki502_dormant_file_limit",
                      &WKSTA_INFO_502::wki502_dormant_file_limit)
            .property("wki502_read_ahead_throughput",
                      &WKSTA_INFO_502::wki502_read_ahead_throughput)
            .property("wki502_num_mailslot_buffers",
                      &WKSTA_INFO_502::wki502_num_mailslot_buffers)
            .property("wki502_num_srv_announce_buffers",
                      &WKSTA_INFO_502::wki502_num_srv_announce_buffers)
            .property("wki502_max_illegal_datagram_events",
                      &WKSTA_INFO_502::wki502_max_illegal_datagram_events)
            .property(
                "wki502_illegal_datagram_event_reset_frequency",
                &WKSTA_INFO_502::wki502_illegal_datagram_event_reset_frequency)
            .property("wki502_log_election_packets",
                      &WKSTA_INFO_502::wki502_log_election_packets)
            .property("wki502_use_opportunistic_locking",
                      &WKSTA_INFO_502::wki502_use_opportunistic_locking)
            .property("wki502_use_unlock_behind",
                      &WKSTA_INFO_502::wki502_use_unlock_behind)
            .property("wki502_use_close_behind",
                      &WKSTA_INFO_502::wki502_use_close_behind)
            .property("wki502_buf_named_pipes",
                      &WKSTA_INFO_502::wki502_buf_named_pipes)
            .property("wki502_use_lock_read_unlock",
                      &WKSTA_INFO_502::wki502_use_lock_read_unlock)
            .property("wki502_utilize_nt_caching",
                      &WKSTA_INFO_502::wki502_utilize_nt_caching)
            .property("wki502_use_raw_read",
                      &WKSTA_INFO_502::wki502_use_raw_read)
            .property("wki502_use_raw_write",
                      &WKSTA_INFO_502::wki502_use_raw_write)
            .property("wki502_use_write_raw_data",
                      &WKSTA_INFO_502::wki502_use_write_raw_data)
            .property("wki502_use_encryption",
                      &WKSTA_INFO_502::wki502_use_encryption)
            .property("wki502_buf_files_deny_write",
                      &WKSTA_INFO_502::wki502_buf_files_deny_write)
            .property("wki502_buf_read_only_files",
                      &WKSTA_INFO_502::wki502_buf_read_only_files)
            .property("wki502_force_core_create_mode",
                      &WKSTA_INFO_502::wki502_force_core_create_mode)
            .property("wki502_use_512_byte_max_transfer",
                      &WKSTA_INFO_502::wki502_use_512_byte_max_transfer),
        xlb_class<WKSTA_TRANSPORT_INFO_0>("WKSTA_TRANSPORT_INFO_0")
            .constructor<>()
            .destructor()
            .property("wkti0_quality_of_service",
                      &WKSTA_TRANSPORT_INFO_0::wkti0_quality_of_service)
            .property("wkti0_number_of_vcs",
                      &WKSTA_TRANSPORT_INFO_0::wkti0_number_of_vcs)
            .property("wkti0_transport_name",
                      &WKSTA_TRANSPORT_INFO_0::wkti0_transport_name)
            .property("wkti0_transport_address",
                      &WKSTA_TRANSPORT_INFO_0::wkti0_transport_address)
            .property("wkti0_wan_ish", &WKSTA_TRANSPORT_INFO_0::wkti0_wan_ish),
        xlb_class<WKSTA_USER_INFO_0>("WKSTA_USER_INFO_0")
            .constructor<>()
            .destructor()
            .property("wkui0_username", &WKSTA_USER_INFO_0::wkui0_username),
        xlb_class<WKSTA_USER_INFO_1>("WKSTA_USER_INFO_1")
            .constructor<>()
            .destructor()
            .property("wkui1_username", &WKSTA_USER_INFO_1::wkui1_username)
            .property("wkui1_logon_domain",
                      &WKSTA_USER_INFO_1::wkui1_logon_domain)
            .property("wkui1_oth_domains",
                      &WKSTA_USER_INFO_1::wkui1_oth_domains)
            .property("wkui1_logon_server",
                      &WKSTA_USER_INFO_1::wkui1_logon_server),
        xlb_class<WKSTA_USER_INFO_1101>("WKSTA_USER_INFO_1101")
            .constructor<>()
            .destructor()
            .property("wkui1101_oth_domains",
                      &WKSTA_USER_INFO_1101::wkui1101_oth_domains),
