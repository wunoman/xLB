...
int load_shl(lua_State *L) {
  ...
  xlb_module(L, MODULE_NAME)({
    ...
    // Class
    // class template
    // xlb_class<CItemIDFactory>("CItemIDFactory") .constructor<>()
    // .destructor()
    //    .method( "CreateItemID", &CItemIDFactory::CreateItemID )
    //    .method( "GetDataFromIDList", &CItemIDFactory::GetDataFromIDList )
    //    .method( "GetDataFromIDList", &CItemIDFactory::GetDataFromIDList )
    //    .method( "GetPropertyFromIDList",
    //    &CItemIDFactory::GetPropertyFromIDList ) .method(
    //    "GetPropertyFromIDList", &CItemIDFactory::GetPropertyFromIDList )
    //    .method( "GetPropertyFromIDList",
    //    &CItemIDFactory::GetPropertyFromIDList ) .method(
    //    "GetPropertyFromIDList", &CItemIDFactory::GetPropertyFromIDList )
    //    .method( "GetPropertyStorage", &CItemIDFactory::GetPropertyStorage )
    //    .method( "GetPropertyStorageFromIDList",
    //    &CItemIDFactory::GetPropertyStorageFromIDList ) .method(
    //    "IsDelegateFolder", &CItemIDFactory::IsDelegateFolder ) .method(
    //    "SetItemAlloc", &CItemIDFactory::SetItemAlloc )
    //    ,

    //_BROWSERFRAMEOPTIONS
    xlb_const("BFO_NONE,", BFO_NONE),
        xlb_const("BFO_BROWSER_PERSIST_SETTINGS,",
        ...
        xlb_const("BIF_PREFER_INTERNET_SHORTCUT,",
                  BIF_PREFER_INTERNET_SHORTCUT),
        xlb_const("BFO_BROWSE_NO_IN_NEW_PROCESS,",
                  BFO_BROWSE_NO_IN_NEW_PROCESS),
        xlb_const("BFO_ENABLE_HYPERLINK_TRACKING,",
                  BFO_ENABLE_HYPERLINK_TRACKING),
        xlb_const("BFO_USE_IE_OFFLINE_SUPPORT,", BFO_USE_IE_OFFLINE_SUPPORT),
        xlb_const("BFO_SUBSTITUE_INTERNET_START_PAGE,",
        ...
        xlb_const("BFO_NO_PARENT_FOLDER_SUPPORT,",
        ...
        xlb_const("BFO_SHOW_NAVIGATION_CANCELLED,",
        ...
        xlb_const("FOS_OKBUTTONNEEDSINTERACTION,",
        ...
        xlb_const("KF_REDIRECT_DEL_SOURCE_CONTENTS,",
        ...
        //_SHCONTF
        xlb_const("SHCONTF_CHECKING_FOR_CHILDREN,",
        ...
        xlb_const("TSF_DELETE_RECYCLE_IF_POSSIBLE,",
        ...
        xlb_const("AL_EFFECTIVE,", AL_EFFECTIVE), xlb_const("AL_USER", AL_USER),
        ...
        xlb_const("ASSOCSTR_SUPPORTED_URI_PROTOCOLS,",
        ...
        xlb_const("ATTACHMENT_PROMPT_EXEC_OR_SAVE",
        ...
        xlb_const("CPCFO_ENABLE_PASSWORD_REVEAL,",
        ...
        xlb_const("CPFS_DISPLAY_IN_SELECTED_TILE,",
                  CPFS_DISPLAY_IN_SELECTED_TILE),
        xlb_const("CPFS_DISPLAY_IN_DESELECTED_TILE,",
        ...
        xlb_const("CPGSR_NO_CREDENTIAL_NOT_FINISHED,",
                  CPGSR_NO_CREDENTIAL_NOT_FINISHED),
        xlb_const("CPGSR_NO_CREDENTIAL_FINISHED,",
                  CPGSR_NO_CREDENTIAL_FINISHED),
        xlb_const("CPGSR_RETURN_CREDENTIAL_FINISHED,",
        ...
        // FDAP
        xlb_const("FDAP_BOTTOM,", FDAP_BOTTOM), xlb_const("FDAP_TOP", FDAP_TOP),
        ...
        // FOLDERVIEWMODE
        xlb_const("FVM_AUTO,", FVM_AUTO), xlb_const("FVM_FIRST,", FVM_FIRST),
        ...
        xlb_const("FVM_CONTENT,", FVM_CONTENT), xlb_const("FVM_LAST", FVM_LAST),
        ...
        xlb_const("KF_FLAG_FORCE_PACKAGE_REDIRECTION,",
                  KF_FLAG_FORCE_PACKAGE_REDIRECTION),
        xlb_const("KF_FLAG_NO_PACKAGE_REDIRECTION,",
        ...
        xlb_const("MIMEASSOCDLG_FL_REGISTER_ASSOC",
        ...
        xlb_const("NSTCS2_INTERRUPTNOTIFICATIONS,",
        ...
        xlb_const("NTSCS2_NOSINGLETONAUTOEXPAND,",
                  NTSCS2_NOSINGLETONAUTOEXPAND),
        xlb_const("NTSCS2_NEVERINSERTNONENUMERATED",
        ...
        xlb_const("QUNS_RUNNING_D3D_FULL_SCREEN,",
        ...
        xlb_const("REST_ENFORCESHELLEXTSECURITY,",
                  REST_ENFORCESHELLEXTSECURITY),
        xlb_const("REST_LINKRESOLVEIGNORELINKINFO,",
        ...
        xlb_const("REST_NOCHANGEMAPPEDDRIVELABEL,",
                  REST_NOCHANGEMAPPEDDRIVELABEL),
        xlb_const("REST_NOCHANGEMAPPEDDRIVECOMMENT,",
        ...
        xlb_const("REST_PROMPTRUNASINSTALLNETPATH,",
        ...
        xlb_const("REST_NOCONTROLPANELBARRICADE,",
        ...
        xlb_const("REST_NODISPLAYAPPEARANCEPAGE,",
        ...
        xlb_const("REST_NODISPSCREENSAVEPREVIEW,",
        ...
        // unsupported
        xlb_const("REST_NOREMOTERECURSIVEEVENTS,",
        ...
        // xlb_const("REST_NODETAILSTHUMBNAILONNETWORK,",
        ...
        xlb_const("REST_ALLOWFILECLSIDJUNCTIONS,",
        ...
        xlb_const("REST_ARP_NOCHOOSEPROGRAMSPAGE,",
        ...
        xlb_const("SECURELOCK_SET_SECUREUNKNOWNBIT,",
        ...
        xlb_const("SHCOLSTATE_NOSORTBYFOLDERNESS,",
        ...
        xlb_const("SLDF_DISABLE_LINK_PATH_TRACKING,",
        ...
        xlb_const("ssfRECENT,", ssfRECENT), xlb_const("ssfSENDTO,", ssfSENDTO),
        ...
        xlb_const("ssfNETHOOD,", ssfNETHOOD), xlb_const("ssfFONTS,", ssfFONTS),
        ...
        xlb_const("GLOBALCOUNTER_SYSTEMPIDLCHANGE,",
                  GLOBALCOUNTER_SYSTEMPIDLCHANGE),
        xlb_const("GLOBALCOUNTER_OVERLAYMANAGER,",
                  GLOBALCOUNTER_OVERLAYMANAGER),
        xlb_const("GLOBALCOUNTER_QUERYASSOCIATIONS,",
                  GLOBALCOUNTER_QUERYASSOCIATIONS),
        xlb_const("GLOBALCOUNTER_IESESSIONS,", GLOBALCOUNTER_IESESSIONS),
        xlb_const("GLOBALCOUNTER_IEONLY_SESSIONS,",
        ...
        xlb_const("GLOBALCOUNTER_RECYCLEBINENUM,",
                  GLOBALCOUNTER_RECYCLEBINENUM),
        xlb_const("GLOBALCOUNTER_RECYCLEBINCORRUPTED,",
        ...
        xlb_const("GLOBALCOUNTER_SETTINGSYNC_ENABLED,",
        ...
        xlb_const("GLOBALCOUNTER_USERINFOCHANGED,",
        ...
        xlb_const("SIID_FIND,", SIID_FIND), xlb_const("SIID_HELP,", SIID_HELP),
        ...
        xlb_const("SIID_ERROR,", SIID_ERROR), xlb_const("SIID_KEY,", SIID_KEY),
        ...
        xlb_const("STPF_USEAPPTHUMBNAILWHENACTIVE,",
        ...
        xlb_const("SYNCMGR_HCM_CAN_BROWSE_CONTENT,",
                  SYNCMGR_HCM_CAN_BROWSE_CONTENT),
        xlb_const("SYNCMGR_HCM_CAN_SHOW_SCHEDULE,",
                  SYNCMGR_HCM_CAN_SHOW_SCHEDULE),
        xlb_const("SYNCMGR_HCM_QUERY_BEFORE_ACTIVATE,",
                  SYNCMGR_HCM_QUERY_BEFORE_ACTIVATE),
        xlb_const("SYNCMGR_HCM_QUERY_BEFORE_DEACTIVATE,",
                  SYNCMGR_HCM_QUERY_BEFORE_DEACTIVATE),
        xlb_const("SYNCMGR_HCM_QUERY_BEFORE_ENABLE,",
                  SYNCMGR_HCM_QUERY_BEFORE_ENABLE),
        xlb_const("SYNCMGR_HCM_QUERY_BEFORE_DISABLE,",
        ...
        xlb_const("SYNCMGR_HPM_PREVENT_ACTIVATE,",
                  SYNCMGR_HPM_PREVENT_ACTIVATE),
        xlb_const("SYNCMGR_HPM_PREVENT_DEACTIVATE,",
        ...
        xlb_const("SYNCMGR_HPM_PREVENT_START_SYNC,",
                  SYNCMGR_HPM_PREVENT_START_SYNC),
        xlb_const("SYNCMGR_HPM_PREVENT_STOP_SYNC,",
        ...
        xlb_const("SYNCMGR_HPM_DISABLE_START_SYNC,",
                  SYNCMGR_HPM_DISABLE_START_SYNC),
        xlb_const("SYNCMGR_HPM_DISABLE_STOP_SYNC,",
                  SYNCMGR_HPM_DISABLE_STOP_SYNC),
        xlb_const("SYNCMGR_HPM_DISABLE_BROWSE,", SYNCMGR_HPM_DISABLE_BROWSE),
        xlb_const("SYNCMGR_HPM_DISABLE_SCHEDULE,",
                  SYNCMGR_HPM_DISABLE_SCHEDULE),
        xlb_const("SYNCMGR_HPM_HIDDEN_BY_DEFAULT,",
                  SYNCMGR_HPM_HIDDEN_BY_DEFAULT),
        xlb_const("SYNCMGR_HPM_BACKGROUND_SYNC_ONLY,",
        ...
        xlb_const("SYNCMGR_ICM_CAN_BROWSE_CONTENT,",
                  SYNCMGR_ICM_CAN_BROWSE_CONTENT),
        xlb_const("SYNCMGR_ICM_QUERY_BEFORE_ENABLE,",
                  SYNCMGR_ICM_QUERY_BEFORE_ENABLE),
        xlb_const("SYNCMGR_ICM_QUERY_BEFORE_DISABLE,",
                  SYNCMGR_ICM_QUERY_BEFORE_DISABLE),
        xlb_const("SYNCMGR_ICM_QUERY_BEFORE_DELETE,",
        ...
        xlb_const("SYNCMGR_IPM_PREVENT_START_SYNC,",
                  SYNCMGR_IPM_PREVENT_START_SYNC),
        xlb_const("SYNCMGR_IPM_PREVENT_STOP_SYNC,",
        ...
        xlb_const("SYNCMGR_IPM_DISABLE_START_SYNC,",
                  SYNCMGR_IPM_DISABLE_START_SYNC),
        xlb_const("SYNCMGR_IPM_DISABLE_STOP_SYNC,",
        ...
        xlb_const("SYNCMGR_IPM_HIDDEN_BY_DEFAULT,",
        ...
        xlb_const("SYNCMGR_PC_REMOVE_FROM_SYNC_SET,",
        ...
        xlb_const("SYNCMGR_PS_UPDATING_INDETERMINATE,",
        ...
        xlb_const("SYNCMGR_RA_REMOVEFROMSYNCSET,",
        ...
        xlb_const("SYNCMGRFLAG_PENDINGDISCONNECT,",
        ...
        // THUMBBUTTONMASK
        xlb_const("THB_BITMAP,", THB_BITMAP), xlb_const("THB_ICON,", THB_ICON),
        ...
        xlb_const("TRANSLATEURL_FL_GUESS_PROTOCOL,",
        ...
        xlb_const("URLASSOCDLG_FL_USE_DEFAULT_NAME,",
                  URLASSOCDLG_FL_USE_DEFAULT_NAME),
        xlb_const("URLASSOCDLG_FL_REGISTER_ASSOC",
        ...
        // Functions
        // xlb_f("_CancelPendingNavigationAsync",
        // _CancelPendingNavigationAsync), // deprecated
        // xlb_f("_CancelPendingView", _CancelPendingView), // deprecated
        // xlb_f("_CloseAndReleaseToolbars", _CloseAndReleaseToolbars), //
        // deprecated xlb_f("_DisableModeless", _DisableModeless), // deprecated
        ...
        // xlb_f("_GetEffectiveClientArea", _GetEffectiveClientArea), //
        // deprecated xlb_f("_GetToolbarCount", _GetToolbarCount), // deprecated
        ...
        // xlb_f("_ResizeNextBorderHelper", _ResizeNextBorderHelper),//
        // deprecated xlb_f("_ResizeView", _ResizeView),// deprecated
        ...
        // xlb_f("AppVisibilityOnMonitorChanged",
        // AppVisibilityOnMonitorChanged), xlb_f("ArePrintersShared",
        // ArePrintersShared), xlb_f("AreSnapshotsAvailable",
        // AreSnapshotsAvailable), xlb_f("ArrangeGrid", ArrangeGrid),
        ...
        // xlb_f("Draw", Draw),
        xlb_f("DriveType", DriveType), xlb_f("DriveType", DriveType),
        // xlb_f("Drop", Drop),
        ...
        // xlb_f("Execute", Execute),
        // xlb_f("Expand", Expand),
        xlb_f("ExpandEnvironmentStringsForUser",
        ...
        xlb_f("FreeKnownFolderDefinitionFields",
        ...
        // xlb_f("GetAppContainerRegistryLocation",
        // GetAppContainerRegistryLocation), xlb_f("GetAppID", GetAppID),
        ...
        // xlb_f("GetApplicationViewOrientation",
        // GetApplicationViewOrientation), xlb_f("GetAppName", GetAppName),
        ...
        // xlb_f("GetPropertyStoreWithCreateObject",
        // GetPropertyStoreWithCreateObject), xlb_f("GetProviderID",
        // GetProviderID), xlb_f("GetPublishedAppInfo", GetPublishedAppInfo),
        ...
        xlb_f("ILAppendID", ILAppendID), xlb_f("ILClone", ILClone),
        xlb_f("ILCloneChild", ILCloneChild),
        xlb_f("ILCloneFirst", ILCloneFirst), xlb_f("ILCloneFull", ILCloneFull),
        xlb_f("ILCombine", ILCombine),
        xlb_f("ILCreateFromPath", ILCreateFromPath),
        xlb_f("ILFindChild", ILFindChild), xlb_f("ILFindLastID", ILFindLastID),
        xlb_f("ILFree", ILFree), xlb_f("ILGetNext", ILGetNext),
        xlb_f("ILGetSize", ILGetSize),

        xlb_f(
            "ILIsAligned",
            [](PCUIDLIST_RELATIVE pidl) -> auto { return ILIsAligned(pidl); }),
        xlb_f(
            "ILIsChild",
            [](PCUIDLIST_RELATIVE pidl) -> auto { return ILIsChild(pidl); }),
        xlb_f(
            "ILIsEmpty",
            [](PCUIDLIST_RELATIVE pidl) -> auto { return ILIsEmpty(pidl); }),

        xlb_f("ILIsEqual", ILIsEqual), xlb_f("ILIsParent", ILIsParent),
        // xlb_f("ILLoadFromStream", ILLoadFromStream),
        xlb_f("ILLoadFromStreamEx", ILLoadFromStreamEx),
        xlb_f(
            "ILNext",
            [](PCUIDLIST_RELATIVE pidl) -> auto { return ILNext(pidl); }),
        xlb_f("ILRemoveLastID", ILRemoveLastID),
        xlb_f("ILSaveToStream", ILSaveToStream),
        xlb_f(
            "ILSkip", [](PCUIDLIST_RELATIVE pidl, unsigned cb) -> auto {
              return ILSkip(pidl, cb);
            }),
        ...
        // xlb_f("IsApplicationViewStateSupported",
        // IsApplicationViewStateSupported), xlb_f("IsBkDropTarget",
        // IsBkDropTarget),
        ...
        xlb_f("IsNetDrive", IsNetDrive), xlb_f("IsOS", IsOS),
        ...
        // xlb_f("IsWindowOnCurrentVirtualDesktop",
        // IsWindowOnCurrentVirtualDesktop), xlb_f("Item", Item), xlb_f("Item",
        // Item), xlb_f("ItemCount", ItemCount), xlb_f("ItemPostPaint",
        // ItemPostPaint), xlb_f("ItemPrePaint", ItemPrePaint), xlb_f("Items",
        // Items),
        ...
        // xlb_f("LoadNonloadedOverlayIdentifiers",
        ...
        xlb_class<xlb_cbf<LPFNDFMCALLBACK>>("LPFNDFMCALLBACK")
            .constructor<xlb_luafunc>(),
        xlb_class<xlb_cbf<LPFNVIEWCALLBACK>>("LPFNVIEWCALLBACK")
            .constructor<xlb_luafunc>(),
        ...
        // xlb_f("OnDoDefaultAccessibilityAction",
        // OnDoDefaultAccessibilityAction), xlb_f("OnDragEnter", OnDragEnter),
        ...
        // xlb_f("OnGetDefaultAccessibilityAction",
        // OnGetDefaultAccessibilityAction), xlb_f("OnGetToolTip",
        // OnGetToolTip), xlb_f("OnHttpEquiv", OnHttpEquiv), xlb_f("OnInvoke",
        // OnInvoke), xlb_f("OnInvoke", OnInvoke), xlb_f("OnItemAdded",
        // OnItemAdded), xlb_f("OnItemClick", OnItemClick),
        ...
        xlb_f("PathAppend", PathAppend), xlb_f("PathBuildRoot", PathBuildRoot),
        ...
        xlb_f<HRESULT APIENTRY (*)(PCWSTR, size_t, PCWSTR *)>(
            "PathCchFindExtension", PathCchFindExtension),
        ...
        xlb_f("PathIsExe", PathIsExe), xlb_f("PathIsFileSpec", PathIsFileSpec),
        ...
        xlb_f("PathIsURL", PathIsURL), xlb_f("PathMakePretty", PathMakePretty),
        ...
        xlb_f("RegisterAppStateChangeNotification",
        ...
        // xlb_f("RegisterForPackageStateChanges",
        // RegisterForPackageStateChanges), xlb_f("RegisterPending",
        // RegisterPending),
        xlb_f("RegisterScaleChangeEvent", RegisterScaleChangeEvent),
        xlb_f("RegisterScaleChangeNotifications",
        ...
        // xlb_f("Scale", Scale),
        // xlb_f( "ScreenSaverConfigureDialog", ScreenSaverConfigureDialog ), //
        // undefined xlb_f( "ScreenSaverProc", ScreenSaverProc ),
        // xlb_f("Select", Select),
        ...
        // xlb_f("SetApplicationViewOrientation",
        // SetApplicationViewOrientation), xlb_f("SetApplicationViewState",
        // SetApplicationViewState), xlb_f("SetArguments", SetArguments),
        ...
        // xlb_f("SetExtendedTileViewProperties",
        // SetExtendedTileViewProperties), xlb_f("SetFieldBitmap",
        // SetFieldBitmap), xlb_f("SetFieldCheckbox", SetFieldCheckbox),
        ...
        xlb_f("SetRect", SetRect), xlb_f("SetRect", SetRect),
        ...
        xlb_f("SHAlloc", SHAlloc), xlb_f("SHAllocShared", SHAllocShared),
        ...
        xlb_f("SHCreateAssociationRegistration",
        ...
        xlb_f("SHCreateQueryCancelAutoPlayMoniker",
        ...
        xlb_f("SHCreateShellItemArrayFromDataObject",
              SHCreateShellItemArrayFromDataObject),
        xlb_f("SHCreateShellItemArrayFromIDLists",
              SHCreateShellItemArrayFromIDLists),
        xlb_f("SHCreateShellItemArrayFromShellItem",
        ...
        xlb_f("ShellAbout", ShellAbout), xlb_f("ShellExecute", ShellExecute),
        ...
        // xlb_f( "SHEnumerateUnreadMailAccounts", SHEnumerateUnreadMailAccounts
        // ), // undefined
        xlb_f("SHEnumKeyEx", SHEnumKeyEx), xlb_f("SHEnumValue", SHEnumValue),
        xlb_f("SHEvaluateSystemCommandTemplate",
        ...
        xlb_f("SHFormatDrive", SHFormatDrive), xlb_f("SHFree", SHFree),
        ...
        xlb_f("SHMapPIDLToSystemImageListIndex",
        ...
        xlb_f("ShortToInt8", ShortToInt8), xlb_f("ShortToUChar", ShortToUChar),
        xlb_f("ShortToUInt", ShortToUInt), xlb_f("ShortToUInt8", ShortToUInt8),
        ...
        // xlb_f( "SHRegGetBoolValueFromHKCUHKLM", SHRegGetBoolValueFromHKCUHKLM
        // ), // undefined
        ...
        // xlb_f( "SHRegGetValueFromHKCUHKLM", SHRegGetValueFromHKCUHKLM ), //
        // undefined
        ...
        // xlb_f( "SHStartNetConnectionDialog", SHStartNetConnectionDialog ), //
        // undefined
        ...
        xlb_f("SignalFileOpen", SignalFileOpen), xlb_f("SizeTAdd", SizeTAdd),
        xlb_f("SizeTMult", SizeTMult), xlb_f("SizeTSub", SizeTSub),
        // xlb_f("Skip", Skip),
        // xlb_f("Skip", Skip),
        // xlb_f("Skip", Skip),
        // xlb_f("Skip", Skip),
        ...
        // xlb_f("Skip", Skip),
        // xlb_f("Skip", Skip),
        // xlb_f( "SoftwareUpdateMessageBox", SoftwareUpdateMessageBox ), //
        // undefined
        ...
        xlb_f("StrCatBuff", StrCatBuff), xlb_f("StrCatChainW", StrCatChainW),
        xlb_f("StrCatW", StrCatW), xlb_f("StrChr", StrChr),
        xlb_f("StrChrI", StrChrI), xlb_f("StrChrNIW", StrChrNIW),
        xlb_f("StrChrNW", StrChrNW), xlb_f("StrCmpC", StrCmpC),
        xlb_f("StrCmpIC", StrCmpIC), xlb_f("StrCmpIW", StrCmpIW),
        xlb_f("StrCmpLogicalW", StrCmpLogicalW), xlb_f("StrCmpN", StrCmpN),
        xlb_f("StrCmpNC", StrCmpNC), xlb_f("StrCmpNI", StrCmpNI),
        xlb_f("StrCmpNIC", StrCmpNIC), xlb_f("StrCmpW", StrCmpW),
        xlb_f("StrCpyNW", StrCpyNW), xlb_f("StrCpyW", StrCpyW),
        xlb_f("StrCSpn", StrCSpn), xlb_f("StrCSpnI", StrCSpnI),
        xlb_f("StrDup", StrDup),
        ...
        xlb_f("StrIsIntlEqual", StrIsIntlEqual), xlb_f("StrNCat", StrNCat),
        xlb_f("StrPBrk", StrPBrk), xlb_f("StrRChr", StrRChr),
        xlb_f("StrRChrI", StrRChrI), xlb_f("StrRetToBSTR", StrRetToBSTR),
        xlb_f("StrRetToBuf", StrRetToBuf), xlb_f("StrRetToStr", StrRetToStr),
        xlb_f("StrRStrI", StrRStrI), xlb_f("StrSpn", StrSpn),
        xlb_f("StrStr", StrStr), xlb_f("StrStrI", StrStrI),
        xlb_f("StrStrNIW", StrStrNIW), xlb_f("StrStrNW", StrStrNW),
        xlb_f("StrToInt64Ex", StrToInt64Ex), xlb_f("StrToInt", StrToInt),
        xlb_f("StrToIntEx", StrToIntEx), xlb_f("StrTrim", StrTrim),

        xlb_class<xlb_cbf<SUBCLASSPROC>>("SUBCLASSPROC")
            .constructor<xlb_luafunc>(),
        ...
        xlb_f("UInt8Add", UInt8Add), xlb_f("UInt8Mult", UInt8Mult),
        xlb_f("UInt8Sub", UInt8Sub), xlb_f("UInt8ToChar", UInt8ToChar),
        xlb_f("UInt8ToInt8", UInt8ToInt8), xlb_f("UIntAdd", UIntAdd),
        xlb_f("UIntMult", UIntMult), xlb_f("UIntPtrAdd", UIntPtrAdd),
        xlb_f("UIntPtrMult", UIntPtrMult), xlb_f("UIntPtrSub", UIntPtrSub),
        ...
        xlb_f("UIntPtrToUShort", UIntPtrToUShort), xlb_f("UIntSub", UIntSub),
        xlb_f("UIntToChar", UIntToChar), xlb_f("UIntToInt", UIntToInt),
        xlb_f("UIntToInt8", UIntToInt8), xlb_f("UIntToIntPtr", UIntToIntPtr),
        xlb_f("UIntToLong", UIntToLong), xlb_f("UIntToLongPtr", UIntToLongPtr),
        xlb_f("UIntToShort", UIntToShort), xlb_f("UIntToUChar", UIntToUChar),
        xlb_f("UIntToUInt8", UIntToUInt8), xlb_f("UIntToUShort", UIntToUShort),
        xlb_f("ULongAdd", ULongAdd), xlb_f("ULongLongAdd", ULongLongAdd),
        ...
        xlb_f("ULongMult", ULongMult), xlb_f("ULongPtrAdd", ULongPtrAdd),
        xlb_f("ULongPtrMult", ULongPtrMult), xlb_f("ULongPtrSub", ULongPtrSub),
        ...
        xlb_f("ULongSub", ULongSub), xlb_f("ULongToChar", ULongToChar),
        xlb_f("ULongToInt", ULongToInt), xlb_f("ULongToInt8", ULongToInt8),
        ...
        xlb_f("ULongToUChar", ULongToUChar), xlb_f("ULongToUInt", ULongToUInt),
        ...
        xlb_f("UnregisterAppStateChangeNotification",
              UnregisterAppStateChangeNotification),
        // xlb_f("UnregisterFolder", UnregisterFolder),
        // xlb_f("UnregisterForPackageStateChanges",
        ...
        xlb_f("UrlCombine", UrlCombine), xlb_f("UrlCompare", UrlCompare),
        xlb_f("UrlCreateFromPath", UrlCreateFromPath),
        xlb_f("UrlEscape", UrlEscape),
        // xlb_f("UrlEscapeSpaces", UrlEscapeSpaces),
        xlb_f("UrlFixupW", UrlFixupW), xlb_f("UrlGetLocation", UrlGetLocation),
        xlb_f("UrlGetPart", UrlGetPart), xlb_f("UrlHash", UrlHash),
        xlb_f("UrlIs", UrlIs),
        // xlb_f("UrlIsFileUrlA", UrlIsFileUrlA),
        // xlb_f("UrlIsFileUrlW", UrlIsFileUrlW),
        // xlb_f( "UrlIsNoHistory", UrlIsNoHistory ),  // no AW
        xlb_f("UrlIsOpaque", UrlIsOpaque), xlb_f("UrlUnescape", UrlUnescape),
        // xlb_f("UrlUnescapeInPlace", UrlUnescapeInPlace),
        xlb_f("UShortAdd", UShortAdd), xlb_f("UShortMult", UShortMult),
        xlb_f("UShortSub", UShortSub), xlb_f("UShortToChar", UShortToChar),
        ...
        xlb_f("Win32DeleteFile", Win32DeleteFile), xlb_f("WinHelp", WinHelp),
        ...
        // Structures
        xlb_class<AASHELLMENUFILENAME>("AASHELLMENUFILENAME")
            .constructor<>()
            .destructor()
        ...
        xlb_class<AASHELLMENUITEM>("AASHELLMENUITEM")
            .constructor<>()
            .destructor()
        ...
        xlb_class<APPBARDATA>("APPBARDATA")
            .constructor<>()
            .destructor()
        ...
        xlb_class<APPCATEGORYINFO>("APPCATEGORYINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<APPINFODATA>("APPINFODATA")
            ...
            .property("pszRegisteredCompany",
                      &APPINFODATA::pszRegisteredCompany)
        ...
        xlb_class<ASSOCIATIONELEMENT>("ASSOCIATIONELEMENT")
            .constructor<>()
            .destructor()
        ...
        xlb_class<AUTO_SCROLL_DATA>("AUTO_SCROLL_DATA")
            .constructor<>()
            .destructor()
        ...
        xlb_class<BANDINFOSFB>("BANDINFOSFB")
            .constructor<>()
            .destructor()
        ...
        xlb_class<BANDSITEINFO>("BANDSITEINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<BASEBROWSERDATALH>("BASEBROWSERDATALH")
            .constructor<>()
            .destructor()
            ...
            .property("_fPrivacyImpacted",
                      &BASEBROWSERDATALH::_fPrivacyImpacted)
            .property("_clsidView", &BASEBROWSERDATALH::_clsidView)
            .property("_clsidViewPending",
                      &BASEBROWSERDATALH::_clsidViewPending)
            .property("_hwndFrame", &BASEBROWSERDATALH::_hwndFrame)
            .property("_lPhishingFilterStatus",
                      &BASEBROWSERDATALH::_lPhishingFilterStatus),

        xlb_class<BASEBROWSERDATAXP>("BASEBROWSERDATAXP")
            .constructor<>()
            .destructor()
            ...
            .property("_fPrivacyImpacted",
                      &BASEBROWSERDATAXP::_fPrivacyImpacted)
            .property("_clsidView", &BASEBROWSERDATAXP::_clsidView)
            .property("_clsidViewPending",
                      &BASEBROWSERDATAXP::_clsidViewPending)
            .property("_hwndFrame", &BASEBROWSERDATAXP::_hwndFrame),

        xlb_class<BROWSEINFO>("BROWSEINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<CABINETSTATE>("CABINETSTATE")
            .constructor<>()
            .destructor()
        ...
        xlb_class<CATEGORY_INFO>("CATEGORY_INFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<CM_COLUMNINFO>("CM_COLUMNINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<CMINVOKECOMMANDINFO>("CMINVOKECOMMANDINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<CMINVOKECOMMANDINFOEX>("CMINVOKECOMMANDINFOEX")
            .constructor<>()
            .destructor()
        ...
        xlb_class<COMDLG_FILTERSPEC>("COMDLG_FILTERSPEC")
            .constructor<>()
            .destructor()
...
//         xlb_class<COMPONENTSOPT>("COMPONENTSOPT")
//             .constructor<>()
//             .destructor()
...
//             .property("fActiveDesktop", &COMPONENTSOPT::fActiveDesktop),
        ...
        // xlb_class<COMPSTATEINFO>("COMPSTATEINFO")
        //     .constructor<>()
        //     .destructor()
        ...
        xlb_class<CONFIRM_CONFLICT_ITEM>("CONFIRM_CONFLICT_ITEM")
            .constructor<>()
            .destructor()
            .property("pShellItem", &CONFIRM_CONFLICT_ITEM::pShellItem)
            .property("pszOriginalName",
                      &CONFIRM_CONFLICT_ITEM::pszOriginalName)
            .property("pszAlternateName",
                      &CONFIRM_CONFLICT_ITEM::pszAlternateName)
            .property("pszLocationShort",
                      &CONFIRM_CONFLICT_ITEM::pszLocationShort)
            .property("pszLocationFull",
                      &CONFIRM_CONFLICT_ITEM::pszLocationFull)
            .property("nType", &CONFIRM_CONFLICT_ITEM::nType),

        xlb_class<CONFIRM_CONFLICT_RESULT_INFO>("CONFIRM_CONFLICT_RESULT_INFO")
            .constructor<>()
            .destructor()
            .property("pszNewName", &CONFIRM_CONFLICT_RESULT_INFO::pszNewName)
            .property("iItemIndex", &CONFIRM_CONFLICT_RESULT_INFO::iItemIndex),

        xlb_class<CPLINFO>("CPLINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION>(
            "CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION")
            .constructor<>()
            .destructor()
            .property("ulAuthenticationPackage",
                      &CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION::
                          ulAuthenticationPackage)
            .property("clsidCredentialProvider",
                      &CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION::
                          clsidCredentialProvider)
            .property(
                "cbSerialization",
                &CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION::cbSerialization)
            .property("rgbSerialization",
                      &CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION::
                          rgbSerialization),

        xlb_class<CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR>(
            "CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR")
            .constructor<>()
            .destructor()
            .property("dwFieldID",
                      &CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR::dwFieldID)
            .property("cpft", &CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR::cpft)
            .property("pszLabel",
                      &CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR::pszLabel)
            .property("guidFieldType",
                      &CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR::guidFieldType),
        ...
        xlb_class<DEFCONTEXTMENU>("DEFCONTEXTMENU")
            ...
            .property("punkAssociationInfo",
                      &DEFCONTEXTMENU::punkAssociationInfo)
            .property("cKeys", &DEFCONTEXTMENU::cKeys)
            .property("aKeys", &DEFCONTEXTMENU::aKeys),

        xlb_class<DELEGATEITEMID>("DELEGATEITEMID")
            .constructor<>()
            .destructor()
        ...
        xlb_class<DESKBANDINFO>("DESKBANDINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<DETAILSINFO>("DETAILSINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<DLLVERSIONINFO>("DLLVERSIONINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<DLLVERSIONINFO2>("DLLVERSIONINFO2")
            .constructor<>()
            .destructor()
        ...
        xlb_class<DROPDESCRIPTION>("DROPDESCRIPTION")
            .constructor<>()
            .destructor()
        ...
        xlb_class<EXP_DARWIN_LINK>("EXP_DARWIN_LINK")
            .constructor<>()
            .destructor()
        ...
        xlb_class<EXP_PROPERTYSTORAGE>("EXP_PROPERTYSTORAGE")
            .constructor<>()
            .destructor()
            .property("cbSize", &EXP_PROPERTYSTORAGE::cbSize)
            .property("dwSignature", &EXP_PROPERTYSTORAGE::dwSignature)
            .property("abPropertyStorage",
                      &EXP_PROPERTYSTORAGE::abPropertyStorage),

        xlb_class<EXP_SPECIAL_FOLDER>("EXP_SPECIAL_FOLDER")
            .constructor<>()
            .destructor()
        ...
        xlb_class<EXP_SZ_LINK>("EXP_SZ_LINK")
            .constructor<>()
            .destructor()
        ...
        xlb_class<EXTRASEARCH>("EXTRASEARCH")
            .constructor<>()
            .destructor()
        ...
        xlb_class<FILE_ATTRIBUTES_ARRAY>("FILE_ATTRIBUTES_ARRAY")
            .constructor<>()
            .destructor()
            .property("cItems", &FILE_ATTRIBUTES_ARRAY::cItems)
            .property("dwSumFileAttributes",
                      &FILE_ATTRIBUTES_ARRAY::dwSumFileAttributes)
            .property("dwProductFileAttributes",
                      &FILE_ATTRIBUTES_ARRAY::dwProductFileAttributes)
            .property("rgdwFileAttributes",
                      &FILE_ATTRIBUTES_ARRAY::rgdwFileAttributes),

        xlb_class<FILEDESCRIPTOR>("FILEDESCRIPTOR")
            .constructor<>()
            .destructor()
        ...
        xlb_class<FILEGROUPDESCRIPTOR>("FILEGROUPDESCRIPTOR")
            .constructor<>()
            .destructor()
            .property("cItems", &FILEGROUPDESCRIPTOR::cItems)
            .property("fgd", &FILEGROUPDESCRIPTOR::fgd),

        xlb_class<FOLDERSETDATA>("FOLDERSETDATA")
            .constructor<>()
            .destructor()
        ...
        xlb_class<FOLDERSETTINGS>("FOLDERSETTINGS")
            .constructor<>()
            .destructor()
        ...
        xlb_class<FVSHOWINFO>("FVSHOWINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<HELPWININFO>("HELPWININFO")
            .constructor<>()
            .destructor()
        ...
        // xlb_class<IE4COMPONENT>("IE4COMPONENT")
        //     .constructor<>()
        //     .destructor()
        ...
        xlb_class<ITEMIDLIST>("ITEMIDLIST")
            .constructor<>()
            .destructor()
            .property("mkid", &ITEMIDLIST::mkid),

        xlb_class<ITEMSPACING>("ITEMSPACING")
            .constructor<>()
            .destructor()
        ...
        xlb_class<KNOWNFOLDER_DEFINITION>("KNOWNFOLDER_DEFINITION")
            .constructor<>()
            .destructor()
            ...
            .property("pszRelativePath",
                      &KNOWNFOLDER_DEFINITION::pszRelativePath)
            .property("pszParsingName", &KNOWNFOLDER_DEFINITION::pszParsingName)
            .property("pszTooltip", &KNOWNFOLDER_DEFINITION::pszTooltip)
            .property("pszLocalizedName",
                      &KNOWNFOLDER_DEFINITION::pszLocalizedName)
        ...
        xlb_class<MULTIKEYHELP>("MULTIKEYHELP")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NC_ADDRESS>("NC_ADDRESS")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NEWCPLINFO>("NEWCPLINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NOTIFYICONDATA>("NOTIFYICONDATA")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NOTIFYICONIDENTIFIER>("NOTIFYICONIDENTIFIER")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NRESARRAY>("NRESARRAY")
            .constructor<>()
            .destructor()
            .property("cItems", &NRESARRAY::cItems)
            .property("nr", &NRESARRAY::nr),

        xlb_class<NSTCCUSTOMDRAW>("NSTCCUSTOMDRAW")
            .constructor<>()
            .destructor()
        ...
        xlb_class<NT_CONSOLE_PROPS>("NT_CONSOLE_PROPS")
            .constructor<>()
            .destructor()
            .property("dbh", &NT_CONSOLE_PROPS::dbh)
            .property("wFillAttribute", &NT_CONSOLE_PROPS::wFillAttribute)
            .property("wPopupFillAttribute",
                      &NT_CONSOLE_PROPS::wPopupFillAttribute)
            .property("dwScreenBufferSize",
                      &NT_CONSOLE_PROPS::dwScreenBufferSize)
            ...
            .property("uHistoryBufferSize",
                      &NT_CONSOLE_PROPS::uHistoryBufferSize)
            .property("uNumberOfHistoryBuffers",
                      &NT_CONSOLE_PROPS::uNumberOfHistoryBuffers)
            .property("bHistoryNoDup", &NT_CONSOLE_PROPS::bHistoryNoDup)
            .property("ColorTable", &NT_CONSOLE_PROPS::ColorTable),

        xlb_class<NT_FE_CONSOLE_PROPS>("NT_FE_CONSOLE_PROPS")
            .constructor<>()
            .destructor()
            .property("dbh", &NT_FE_CONSOLE_PROPS::dbh)
            .property("uCodePage", &NT_FE_CONSOLE_PROPS::uCodePage),

        xlb_class<OPEN_PRINTER_PROPS_INFO>("OPEN_PRINTER_PROPS_INFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<OPENASINFO>("OPENASINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<OVERLAPPED>("OVERLAPPED")
            .constructor<>()
            .destructor()
        ...
        xlb_class<PERSIST_FOLDER_TARGET_INFO>("PERSIST_FOLDER_TARGET_INFO")
            .constructor<>()
            .destructor()
            .property("pidlTargetFolder",
                      &PERSIST_FOLDER_TARGET_INFO::pidlTargetFolder)
            .property("szTargetParsingName",
                      &PERSIST_FOLDER_TARGET_INFO::szTargetParsingName)
            .property("szNetworkProvider",
                      &PERSIST_FOLDER_TARGET_INFO::szNetworkProvider)
            .property("dwAttributes", &PERSIST_FOLDER_TARGET_INFO::dwAttributes)
            .property("csidl", &PERSIST_FOLDER_TARGET_INFO::csidl),

        xlb_class<PREVIEWHANDLERFRAMEINFO>("PREVIEWHANDLERFRAMEINFO")
            .constructor<>()
            .destructor()
            .property("haccel", &PREVIEWHANDLERFRAMEINFO::haccel)
            .property("cAccelEntries", &PREVIEWHANDLERFRAMEINFO::cAccelEntries),

        xlb_class<PROFILEINFO>("PROFILEINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<PUBAPPINFO>("PUBAPPINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHChangeNotifyEntry>("SHChangeNotifyEntry")
            .constructor<>()
            .destructor()
            .property("pidl", &SHChangeNotifyEntry::pidl)
            .property("fRecursive", &SHChangeNotifyEntry::fRecursive),

        xlb_class<SHChangeProductKeyAsIDList>("SHChangeProductKeyAsIDList")
            .constructor<>()
            .destructor()
            .property("cb", &SHChangeProductKeyAsIDList::cb)
            .property("wszProductKey",
                      &SHChangeProductKeyAsIDList::wszProductKey)
            .property("cbZero", &SHChangeProductKeyAsIDList::cbZero),

        xlb_class<SHChangeUpdateImageIDList>("SHChangeUpdateImageIDList")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHCOLUMNDATA>("SHCOLUMNDATA")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHCOLUMNINFO>("SHCOLUMNINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHCOLUMNINIT>("SHCOLUMNINIT")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHCREATEPROCESSINFOW>("SHCREATEPROCESSINFOW")
            .constructor<>()
            .destructor()
            ...
            .property("pszCurrentDirectory",
                      &SHCREATEPROCESSINFOW::pszCurrentDirectory)
            .property("hUserToken", &SHCREATEPROCESSINFOW::hUserToken)
            .property("lpProcessAttributes",
                      &SHCREATEPROCESSINFOW::lpProcessAttributes)
            .property("lpThreadAttributes",
                      &SHCREATEPROCESSINFOW::lpThreadAttributes)
            ...
            .property("lpProcessInformation",
                      &SHCREATEPROCESSINFOW::lpProcessInformation),

        xlb_class<SHDESCRIPTIONID>("SHDESCRIPTIONID")
            .constructor<>()
            .destructor()
            .property("dwDescriptionId", &SHDESCRIPTIONID::dwDescriptionId)
            .property("clsid", &SHDESCRIPTIONID::clsid),

        xlb_class<SHDRAGIMAGE>("SHDRAGIMAGE")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHELLEXECUTEINFO>("SHELLEXECUTEINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHELLFLAGSTATE>("SHELLFLAGSTATE")
            .constructor<>()
            .destructor()
            // bitfield
        ...
        xlb_class<SHELLSTATE>("SHELLSTATE")
            .constructor<>()
            .destructor()
            // bitfield
        ...
        xlb_class<SHFILEINFO>("SHFILEINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHFILEOPSTRUCT>("SHFILEOPSTRUCT")
            .constructor<>()
            .destructor()
            ...
            .property("fAnyOperationsAborted",
                      &SHFILEOPSTRUCT::fAnyOperationsAborted)
            .property("hNameMappings", &SHFILEOPSTRUCT::hNameMappings)
            .property("lpszProgressTitle", &SHFILEOPSTRUCT::lpszProgressTitle),

        xlb_class<SHFOLDERCUSTOMSETTINGS>("SHFOLDERCUSTOMSETTINGS")
            .constructor<>()
            .destructor()
            ...
            .property("pszWebViewTemplate",
                      &SHFOLDERCUSTOMSETTINGS::pszWebViewTemplate)
            .property("cchWebViewTemplate",
                      &SHFOLDERCUSTOMSETTINGS::cchWebViewTemplate)
            .property("pszWebViewTemplateVersion",
                      &SHFOLDERCUSTOMSETTINGS::pszWebViewTemplateVersion)
        ...
        xlb_class<SHITEMID>("SHITEMID")
            .constructor<>()
            .destructor()
            .property("cb", &SHITEMID::cb)
            .property("abID", &SHITEMID::abID),

        xlb_class<SHNAMEMAPPING>("SHNAMEMAPPING")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHQUERYRBINFO>("SHQUERYRBINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SHSTOCKICONINFO>("SHSTOCKICONINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SLOWAPPINFO>("SLOWAPPINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SMCSHCHANGENOTIFYSTRUCT>("SMCSHCHANGENOTIFYSTRUCT")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SOFTDISTINFO>("SOFTDISTINFO")
            .constructor<>()
            .destructor()
            ...
            .property("dwInstalledVersionMS",
                      &SOFTDISTINFO::dwInstalledVersionMS)
            .property("dwInstalledVersionLS",
                      &SOFTDISTINFO::dwInstalledVersionLS)
            .property("dwUpdateVersionMS", &SOFTDISTINFO::dwUpdateVersionMS)
            .property("dwUpdateVersionLS", &SOFTDISTINFO::dwUpdateVersionLS)
            .property("dwAdvertisedVersionMS",
                      &SOFTDISTINFO::dwAdvertisedVersionMS)
            .property("dwAdvertisedVersionLS",
                      &SOFTDISTINFO::dwAdvertisedVersionLS)
            .property("dwReserved", &SOFTDISTINFO::dwReserved),

        xlb_class<SORTCOLUMN>("SORTCOLUMN")
            .constructor<>()
            .destructor()
            .property("propkey", &SORTCOLUMN::propkey)
            .property("direction", &SORTCOLUMN::direction),

        xlb_class<STRRET>("STRRET")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SV2CVW2_PARAMS>("SV2CVW2_PARAMS")
            .constructor<>()
            .destructor()
        ...
        xlb_class<SYNCMGRPROGRESSITEM>("SYNCMGRPROGRESSITEM")
            .constructor<>()
            .destructor()
        ...
        xlb_class<TOOLBARITEM>("TOOLBARITEM")
            .constructor<>()
            .destructor()
        ...
        xlb_class<WTS_THUMBNAILID>("WTS_THUMBNAILID")
            .constructor<>()
            .destructor()
