...
int load_dlg(lua_State *L) {
  ...
  xlb_module(L, MODULE_NAME)(
      {xlb_f("HIWORD", [](DWORD dw) { return HIWORD(dw); }),
       ...
       xlb_f(
           "CreateDialog",
           [](HINSTANCE hInstance, LPCTSTR lpTemplateName, HWND hWndParent, DLGPROC lpDialogFunc) {
             return CreateDialog(hInstance, lpTemplateName, hWndParent, lpDialogFunc);
           }),

       xlb_f(
           "CreateDialogIndirect",
           [](HINSTANCE hInstance, LPCDLGTEMPLATEA lpTemplate, HWND hWndParent,
       ...
       xlb_f(
           "DialogBox",
           [](HINSTANCE hInstance, LPCTSTR lpTemplateName, HWND hWndParent, DLGPROC lpDialogFunc) {
             return DialogBox(hInstance, lpTemplateName, hWndParent, lpDialogFunc);
           }),

       xlb_f(
           "DialogBoxIndirect",
           [](HINSTANCE hInstance, LPCDLGTEMPLATEA hDialogTemplate, HWND hWndParent,
              DLGPROC lpDialogFunc) {
             return DialogBoxIndirect(hInstance, hDialogTemplate, hWndParent, lpDialogFunc);
           }),
       ...
       xlb_f("EndDialog", EndDialog), xlb_f("FindText", FindText),
       ...
       xlb_f("GetDialogBaseUnits", GetDialogBaseUnits), xlb_f("GetDlgCtrlID", GetDlgCtrlID),
       xlb_f("GetDlgItem", GetDlgItem), xlb_f("GetDlgItemInt", GetDlgItemInt),
       xlb_f("GetDlgItemText", GetDlgItemText), xlb_f("GetFileTitle", GetFileTitle),
       xlb_f("GetNextDlgGroupItem", GetNextDlgGroupItem),
       xlb_f("GetNextDlgTabItem", GetNextDlgTabItem), xlb_f("GetOpenFileName", GetOpenFileName),
       xlb_f("GetSaveFileName", GetSaveFileName), xlb_f("IsDialogMessage", IsDialogMessage),
       ...
       xlb_f("MapDialogRect", MapDialogRect), xlb_f("MessageBox", MessageBox),

       xlb_const("MB_ABORTRETRYIGNORE", MB_ABORTRETRYIGNORE),
       xlb_const("MB_CANCELTRYCONTINUE", MB_CANCELTRYCONTINUE), xlb_const("MB_HELP", MB_HELP),
       xlb_const("MB_OK", MB_OK), xlb_const("MB_OKCANCEL", MB_OKCANCEL),
       xlb_const("MB_RETRYCANCEL", MB_RETRYCANCEL), xlb_const("MB_YESNO", MB_YESNO),
       xlb_const("MB_YESNOCANCEL", MB_YESNOCANCEL), xlb_const("MB_DEFBUTTON1", MB_DEFBUTTON1),
       xlb_const("MB_DEFBUTTON2", MB_DEFBUTTON2), xlb_const("MB_DEFBUTTON3", MB_DEFBUTTON3),
       xlb_const("MB_DEFBUTTON4", MB_DEFBUTTON4), xlb_const("MB_APPLMODAL", MB_APPLMODAL),
       xlb_const("MB_SYSTEMMODAL", MB_SYSTEMMODAL), xlb_const("MB_TASKMODAL", MB_TASKMODAL),
       xlb_const("MB_DEFAULT_DESKTOP_ONLY", MB_DEFAULT_DESKTOP_ONLY),
       xlb_const("MB_RIGHT", MB_RIGHT), xlb_const("MB_RTLREADING", MB_RTLREADING),
       xlb_const("MB_SETFOREGROUND", MB_SETFOREGROUND), xlb_const("MB_TOPMOST", MB_TOPMOST),
       xlb_const("MB_SERVICE_NOTIFICATION", MB_SERVICE_NOTIFICATION), xlb_const("IDABORT", IDABORT),
       xlb_const("IDCANCEL", IDCANCEL), xlb_const("IDCONTINUE", IDCONTINUE),
       xlb_const("IDIGNORE", IDIGNORE), xlb_const("IDNO", IDNO), xlb_const("IDOK", IDOK),
       xlb_const("IDRETRY", IDRETRY), xlb_const("IDTRYAGAIN", IDTRYAGAIN),
       xlb_const("IDYES", IDYES),

       xlb_const("MB_ICONEXCLAMATION", MB_ICONEXCLAMATION),
       xlb_const("MB_ICONWARNING", MB_ICONWARNING),
       xlb_const("MB_ICONINFORMATION", MB_ICONINFORMATION),
       xlb_const("MB_ICONASTERISK", MB_ICONASTERISK), xlb_const("MB_ICONQUESTION", MB_ICONQUESTION),
       xlb_const("MB_ICONSTOP", MB_ICONSTOP), xlb_const("MB_ICONERROR", MB_ICONERROR),
       xlb_const("MB_ICONHAND", MB_ICONHAND),

       xlb_f("MessageBoxEx", MessageBoxEx), xlb_f("MessageBoxIndirect", MessageBoxIndirect),
       xlb_f("ReplaceText", ReplaceText), xlb_f("SendDlgItemMessage", SendDlgItemMessage),
       xlb_f("SetDlgItemInt", SetDlgItemInt), xlb_f("SetDlgItemText", SetDlgItemText),

       xlb_class<CHOOSEFONT>("CHOOSEFONT")
           .constructor<>()
           .destructor()
       ...
       xlb_class<DLGITEMTEMPLATE>("DLGITEMTEMPLATE")
           .constructor<>()
           .destructor()
       ...
       xlb_class<DLGTEMPLATE>("DLGTEMPLATE")
           .constructor<>()
           .destructor()
       ...
       xlb_class<FINDREPLACE>("FINDREPLACE")
           .constructor<>()
           .destructor()
       ...
       xlb_class<MSGBOXPARAMS>("MSGBOXPARAMS")
           .constructor<>()
           .destructor()
       ...
       xlb_class<OPENFILENAME>("OPENFILENAME")
           .constructor<>()
           .destructor()
       ...
       xlb_class<PAGESETUPDLG>("PAGESETUPDLG")
           .constructor<>()
           .destructor()
       ...
       xlb_class<PRINTDLGEX>("PRINTDLGEX")
           .constructor<>()
           .destructor()
           ...
           //// becuase HPROPSHEETPAGE is a _PSP*, but _PSP is not defined
           /// properly
           .property(
               "lphPropertyPages",
               reinterpret_cast<void * * PRINTDLGEX::*>(&PRINTDLGEX::lphPropertyPages))
           .property("nStartPage", &PRINTDLGEX::nStartPage)
           .property("dwResultAction", &PRINTDLGEX::dwResultAction),
       xlb_class<PRINTPAGERANGE>("PRINTPAGERANGE")
           .constructor<>()
           .destructor()
