...
int load_dialog(lua_State* L)
{
    ...
    xlb_module(L, MODULE_NAME) ({
        ...
        xlb_const("MB_CANCELTRYCONTINUE", MB_CANCELTRYCONTINUE),
        xlb_const("MB_HELP", MB_HELP),
        xlb_const("MB_OK", MB_OK),
        xlb_const("MB_OKCANCEL", MB_OKCANCEL),
        xlb_const("MB_RETRYCANCEL", MB_RETRYCANCEL),
        xlb_const("MB_YESNO", MB_YESNO),
        xlb_const("MB_YESNOCANCEL", MB_YESNOCANCEL),
        xlb_const("MB_DEFBUTTON1", MB_DEFBUTTON1),
        xlb_const("MB_DEFBUTTON2", MB_DEFBUTTON2),
        xlb_const("MB_DEFBUTTON3", MB_DEFBUTTON3),
        xlb_const("MB_DEFBUTTON4", MB_DEFBUTTON4),
        xlb_const("MB_APPLMODAL", MB_APPLMODAL),
        xlb_const("MB_SYSTEMMODAL", MB_SYSTEMMODAL),
        xlb_const("MB_TASKMODAL", MB_TASKMODAL),
        xlb_const("MB_DEFAULT_DESKTOP_ONLY", MB_DEFAULT_DESKTOP_ONLY),
        xlb_const("MB_RIGHT", MB_RIGHT),
        xlb_const("MB_RTLREADING", MB_RTLREADING),
        xlb_const("MB_SETFOREGROUND", MB_SETFOREGROUND),
        xlb_const("MB_TOPMOST", MB_TOPMOST),
        xlb_const("MB_SERVICE_NOTIFICATION", MB_SERVICE_NOTIFICATION),
        xlb_const("IDABORT", IDABORT),
        xlb_const("IDCANCEL", IDCANCEL),
        xlb_const("IDCONTINUE", IDCONTINUE),
        xlb_const("IDIGNORE", IDIGNORE),
        xlb_const("IDNO", IDNO),
        xlb_const("IDOK", IDOK),
        xlb_const("IDRETRY", IDRETRY),
        xlb_const("IDTRYAGAIN", IDTRYAGAIN),
        ...
        xlb_const("MB_ICONASTERISK", MB_ICONASTERISK),
        xlb_const("MB_ICONQUESTION", MB_ICONQUESTION),
        xlb_const("MB_ICONSTOP", MB_ICONSTOP),
        xlb_const("MB_ICONERROR", MB_ICONERROR),
