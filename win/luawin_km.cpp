...
int load_km(lua_State* L)
{
    ...
    xlb_module(L, MODULE_NAME) ({
            ...
            xlb_f("GET_APPCOMMAND_LPARAM", [](LPARAM lp)->auto { return GET_APPCOMMAND_LPARAM(lp); } ),
            xlb_f("GET_DEVICE_LPARAM", [](LPARAM lp)->auto { return GET_DEVICE_LPARAM(lp); } ),
            xlb_f("GET_FLAGS_LPARAM", [](LPARAM lp)->auto { return GET_FLAGS_LPARAM(lp); } ),
            xlb_f("GET_KEYSTATE_LPARAM", [](LPARAM lp)->auto { return GET_KEYSTATE_LPARAM(lp); } ),
            xlb_f("GET_KEYSTATE_WPARAM", [](LPARAM wp)->auto { return GET_KEYSTATE_WPARAM(wp); } ),
            xlb_f("GET_NCHITTEST_WPARAM", [](LPARAM wp)->auto { return GET_NCHITTEST_WPARAM(wp); } ),
            xlb_f("GET_RAWINPUT_CODE_WPARAM", [](LPARAM wp)->auto { return GET_RAWINPUT_CODE_WPARAM(wp); } ),
            xlb_f("GET_WHEEL_DELTA_WPARAM", [](LPARAM wp)->auto { return GET_WHEEL_DELTA_WPARAM(wp); } ),
            xlb_f("GET_XBUTTON_WPARAM", [](LPARAM wp)->auto { return GET_XBUTTON_WPARAM(wp); } ),
            ...
            xlb_f("NEXTRAWINPUTBLOCK", [](RAWINPUT* ptr)->auto { return NEXTRAWINPUTBLOCK(ptr); } ),
            ...
            xlb_f("VkKeyScanA", VkKeyScanA),
            xlb_f("VkKeyScanExA", VkKeyScanExA),
            xlb_f("VkKeyScanExW", VkKeyScanExW),
            xlb_f("VkKeyScanW", VkKeyScanW),

            // Structures
            xlb_class<HARDWAREINPUT>("HARDWAREINPUT") .constructor<>() .destructor()
                .property("uMsg", &HARDWAREINPUT::uMsg)
                .property("wParamL", &HARDWAREINPUT::wParamL)
                .property("wParamH", &HARDWAREINPUT::wParamH)
                ,
            xlb_class<INPUT>("INPUT") .constructor<>() .destructor()
                .property("type", &INPUT::type)
                .property("mi", &INPUT::mi)
                .property("ki", &INPUT::ki)
                .property("hi", &INPUT::hi)
                ,
            xlb_class<KEYBDINPUT>("KEYBDINPUT") .constructor<>() .destructor()
                ...
                ,
            xlb_class<LASTINPUTINFO>("LASTINPUTINFO") .constructor<>() .destructor()
                .property("cbSize", &LASTINPUTINFO::cbSize)
                .property("dwTime", &LASTINPUTINFO::dwTime)
                ,
            xlb_class<MOUSEINPUT>("MOUSEINPUT") .constructor<>() .destructor()
                ...
                ,
            xlb_class<MOUSEMOVEPOINT>("MOUSEMOVEPOINT") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RAWHID>("RAWHID") .constructor<>() .destructor()
                .property("dwSizeHid", &RAWHID::dwSizeHid)
                .property("dwCount", &RAWHID::dwCount)
                .property("bRawData", &RAWHID::bRawData)
                ,

            xlb_class<RAWINPUT>("RAWINPUT") .constructor<>() .destructor()
                .property("header", &RAWINPUT::header)
                .property("data", &RAWINPUT::data)
                ,
            xlb_class<decltype(RAWINPUT::data)>("RAWINPUT::data") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RAWINPUTDEVICE>("RAWINPUTDEVICE") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RAWINPUTDEVICELIST>("RAWINPUTDEVICELIST") .constructor<>() .destructor()
                .property("hDevice", &RAWINPUTDEVICELIST::hDevice)
                .property("dwType", &RAWINPUTDEVICELIST::dwType)
                ,
            xlb_class<RAWINPUTHEADER>("RAWINPUTHEADER") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RAWKEYBOARD>("RAWKEYBOARD") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RAWMOUSE>("RAWMOUSE") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RID_DEVICE_INFO>("RID_DEVICE_INFO") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RID_DEVICE_INFO_HID>("RID_DEVICE_INFO_HID") .constructor<>() .destructor()
                ...
                ,
            xlb_class<RID_DEVICE_INFO_KEYBOARD>("RID_DEVICE_INFO_KEYBOARD") .constructor<>() .destructor()
                .property("dwType", &RID_DEVICE_INFO_KEYBOARD::dwType)
                .property("dwSubType", &RID_DEVICE_INFO_KEYBOARD::dwSubType)
                .property("dwKeyboardMode", &RID_DEVICE_INFO_KEYBOARD::dwKeyboardMode)
                .property("dwNumberOfFunctionKeys", &RID_DEVICE_INFO_KEYBOARD::dwNumberOfFunctionKeys)
                .property("dwNumberOfIndicators", &RID_DEVICE_INFO_KEYBOARD::dwNumberOfIndicators)
                .property("dwNumberOfKeysTotal", &RID_DEVICE_INFO_KEYBOARD::dwNumberOfKeysTotal)
                ,
            xlb_class<RID_DEVICE_INFO_MOUSE>("RID_DEVICE_INFO_MOUSE") .constructor<>() .destructor()
                .property("dwId", &RID_DEVICE_INFO_MOUSE::dwId)
                .property("dwNumberOfButtons", &RID_DEVICE_INFO_MOUSE::dwNumberOfButtons)
                .property("dwSampleRate", &RID_DEVICE_INFO_MOUSE::dwSampleRate)
                .property("fHasHorizontalWheel", &RID_DEVICE_INFO_MOUSE::fHasHorizontalWheel)
                ,
            xlb_class<TRACKMOUSEEVENT>("TRACKMOUSEEVENT") .constructor<>() .destructor()
...
#ifdef compile
#endif
            xlb_const("CHECK_BIND_KM", CHECK_BIND_KM)
    });
#endif // defined(CHECK_BIND_KM)
