...
int load_com(lua_State *L) {
  ...
  xlb_module(L, MODULE_NAME)({
    ...
    xlb_f("BindMoniker", BindMoniker), xlb_f("CLSIDFromProgID", CLSIDFromProgID),
        ...
        xlb_f("CoDisconnectObject", CoDisconnectObject), xlb_f("CoFileTimeNow", CoFileTimeNow),
        xlb_f("CoFreeAllLibraries", CoFreeAllLibraries), xlb_f("CoFreeLibrary", CoFreeLibrary),
        xlb_f("CoFreeUnusedLibraries", CoFreeUnusedLibraries),
        xlb_f("CoGetCallContext", CoGetCallContext), xlb_f("CoGetClassObject", CoGetClassObject),
        ...
        xlb_f("CoGetMalloc", CoGetMalloc), xlb_f("CoGetMarshalSizeMax", CoGetMarshalSizeMax),
        ...
        xlb_f("CoImpersonateClient", CoImpersonateClient), xlb_f("CoInitialize", CoInitialize),
        xlb_f("CoInitializeEx", CoInitializeEx),
        xlb_f("CoInitializeSecurity", CoInitializeSecurity),
        xlb_f("CoIsHandlerConnected", CoIsHandlerConnected), xlb_f("CoIsOle1Class", CoIsOle1Class),
        xlb_f("CoLoadLibrary", CoLoadLibrary), xlb_f("CoLockObjectExternal", CoLockObjectExternal),
        xlb_f("CoMarshalHresult", CoMarshalHresult),
        xlb_f("CoMarshalInterface", CoMarshalInterface),
        xlb_f("CoMarshalInterThreadInterfaceInStream", CoMarshalInterThreadInterfaceInStream),
        ...
        xlb_f("CoRevertToSelf", CoRevertToSelf), xlb_f("CoRevokeClassObject", CoRevokeClassObject),
        ...
        xlb_f("CoSwitchCallContext", CoSwitchCallContext), xlb_f("CoTaskMemAlloc", CoTaskMemAlloc),
        xlb_f("CoTaskMemFree", CoTaskMemFree), xlb_f("CoTaskMemRealloc", CoTaskMemRealloc),
        ...
        xlb_f("CreateAntiMoniker", CreateAntiMoniker), xlb_f("CreateBindCtx", CreateBindCtx),
        ...
        xlb_f("GetClassFile", GetClassFile), xlb_f("GetRunningObjectTable", GetRunningObjectTable),
        ...
        xlb_f("ProgIDFromCLSID", ProgIDFromCLSID), xlb_f("StringFromCLSID", StringFromCLSID),
        ...
        xlb_interface<IUnknown>("IUnknown")
            ...
            .method<HRESULT (IUnknown::*)(REFIID, void **)>(
        ...
        xlb_class<BIND_OPTS2>("BIND_OPTS2")
            .constructor<>()
            .destructor()
        ...
        xlb_const("CLSCTX_LOCAL_SERVER", CLSCTX_LOCAL_SERVER),
        xlb_const("CLSCTX_REMOTE_SERVER", CLSCTX_REMOTE_SERVER),
        xlb_const("CLSCTX_SERVER", CLSCTX_SERVER), xlb_const("CLSCTX_ALL", CLSCTX_ALL),

        xlb_class<COAUTHINFO>("COAUTHINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<CONTROLINFO>("CONTROLINFO")
            .constructor<>()
            .destructor()
        ...
        xlb_class<COSERVERINFO>("COSERVERINFO")
            .constructor<>()
            .destructor()
        ...
        // DATADIR;
        xlb_const("DATADIR_GET", DATADIR_GET), xlb_const("DATADIR_SET", DATADIR_SET),
        ...
        xlb_const("HITRESULT_CLOSE", HITRESULT_CLOSE), xlb_const("HITRESULT_HIT", HITRESULT_HIT),

        // MKRREDUCE
        xlb_const("MKRREDUCE_ONE", MKRREDUCE_ONE), xlb_const("MKRREDUCE_TOUSER", MKRREDUCE_TOUSER),
        ...
        // STGC
        xlb_const("STGC_DEFAULT", STGC_DEFAULT), xlb_const("STGC_OVERWRITE", STGC_OVERWRITE),
